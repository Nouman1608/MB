...
// Every factor below is visible in the output row ("reason" field) --
// nothing here is a hidden or ML-derived score. Weights are intentionally
// simple (integer point values) so the ranking is auditable by a human
// without re-running the script. See docs/growth/gsc-scoring-methodology.md
// for the rationale behind each weight and worked examples.
