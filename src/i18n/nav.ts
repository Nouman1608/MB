...
export const NAV_COPY: Record<LocaleCode, NavCopy> = {
  ar: {
    ...
    form: {
      ...
      messageHintStudent: 'ما الذي يحتاج الطالب المساعدة فيه؟ يُرجى ذكر البرنامج (مثل IGCSE أو A Level)، ومجلس الامتحان إن كان معروفًا، والمادة، والمستوى.',
      messageHintTrial: 'أخبرنا بما تريد أن يغطيه الدرس التجريبي: البرنامج أو المؤهل (مثل IGCSE أو A Level)، مجلس الامتحان إن كان معروفًا، المادة، المستوى، الأيام/الأوقات المفضلة والمنطقة الزمنية، وما الدعم الذي تحتاجه.',
      messageHintTutoring: 'ما الذي يحتاج الطالب المساعدة فيه؟ يُرجى ذكر البرنامج (مثل IGCSE أو A Level)، ومجلس الامتحان إن كان معروفًا، والمادة، والمستوى.',
  ...
  bn: {
    ...
    languageNoteSuffix: '(AI-সহায়তায় অনুবাদ, পর্যালোচনাধীন)',
    primaryNav: [
      { key: 'programs', label: 'প্রোগ্রাম' },
      { key: 'subjects', label: 'বিষয়সমূহ' },
    ...
    footerCompanyHeading: 'কোম্পানি',
    footerCompany: [
      { key: 'about', label: 'আমাদের সম্পর্কে' },
      { key: 'contact', label: 'যোগাযোগ' },
      { key: 'legal-editorial-policy', label: 'সম্পাদকীয় ও বিশ্বাস নীতি' },
      { key: 'legal-privacy', label: 'গোপনীয়তা নীতি' },
    ...
    form: {
      ...
      optional: '(ঐচ্ছিক)', school: 'স্কুল', role: 'আপনার ভূমিকা', roleOptions: ['প্রধান শিক্ষক', 'বিভাগীয় প্রধান', 'শিক্ষক', 'সমন্বয়কারী', 'অন্যান্য'],
      rolePlaceholder: 'অনুগ্রহ করে নির্বাচন করুন',
      messageHintStudent: 'শিক্ষার্থীর কী বিষয়ে সাহায্য দরকার? অনুগ্রহ করে প্রোগ্রাম (যেমন IGCSE, A Level), পরীক্ষা বোর্ড জানা থাকলে, বিষয় এবং স্তর উল্লেখ করুন।',
      messageHintTrial: 'ট্রায়াল ক্লাসে কী কভার করতে চান তা আমাদের জানান: আপনার প্রোগ্রাম বা যোগ্যতা (যেমন IGCSE, A Level), পরীক্ষা বোর্ড জানা থাকলে, বিষয়, স্তর, পছন্দের দিন/সময় ও সময় অঞ্চল, এবং কী ধরনের সহায়তা প্রয়োজন।',
      messageHintTutoring: 'শিক্ষার্থীর কী বিষয়ে সাহায্য দরকার? অনুগ্রহ করে প্রোগ্রাম (যেমন IGCSE, A Level), পরীক্ষা বোর্ড জানা থাকলে, বিষয় এবং স্তর উল্লেখ করুন।',
      messageHintSchool: 'আপনার স্কুলের কী প্রয়োজন?',
      trialNote: 'এটি একটি অনুরোধ পাঠায়, নিশ্চিত বুকিং নয় — শিক্ষক ও সময় নিশ্চিত করার পর মার্লব্রিজ ইমেইলে জবাব দেবে।',
      privacyPrefix: 'এই ফর্মটি জমা দিয়ে আপনি মার্লব্রিজের ',
      privacyLinkText: 'গোপনীয়তা নীতি',
      privacySuffix: '-তে সম্মত হচ্ছেন — আপনার তথ্য শুধুমাত্র আপনার অনুরোধের জবাব দিতে ব্যবহৃত হয়।',
      submit: 'অনুরোধ পাঠান',
      preferEmail: 'ইমেইল পছন্দ করেন? আমাদের লিখুন',
      sending: 'পাঠানো হচ্ছে…',
      successMessage: 'ধন্যবাদ — আপনার অনুরোধ পাঠানো হয়েছে। আমরা ইমেইলে জবাব দেব।',
      genericError: 'আপনার অনুরোধ পাঠানো যায়নি।',
      networkError: 'সার্ভারে পৌঁছানো যায়নি। অনুগ্রহ করে আপনার সংযোগ পরীক্ষা করুন, অথবা আমাদের ইমেইল করুন।',
