...
export const DIRECTORY_COPY: Record<'boards' | 'checklists' | 'levels' | 'programs' | 'resources' | 'subjects' | 'articles', Record<LocaleCode, DirectoryCopy>> = {
  ...
  resources: {
    ar: { title: 'مصادر التعلّم', description: 'أدلة دراسية وملاحظات مراجعة كتبها الفريق الأكاديمي لمارلبريدج. مجانية للقراءة، ومنظّمة حسب المادة والمستوى والموضوع.', eyebrow: 'المصادر', heading: 'مصادر تعليمية متاحة مجانًا', lead: 'مواد دراسية كتبها الفريق الأكاديمي لمارلبريدج، منظمة حسب المادة والمستوى والموضوع. مجانية للقراءة، وتُضاف موضوعًا بموضوع.', englishNote: 'المصادر المنشورة أدناه بالإنجليزية.', combinationsLabel: 'مجموعة', boardsLabel: 'مجلس', qualificationsLabel: 'مؤهل', viewLabel: 'عرض', notOffered: 'قيد التطوير.' },
    ur: { title: 'تعلیمی مواد', description: 'مارل برج اکیڈمک ٹیم کے لکھے ہوئے مطالعاتی گائیڈز اور نظرثانی نوٹس۔ پڑھنے کے لیے مفت، اور مضمون، سطح اور موضوع کے مطابق منظم۔', eyebrow: 'مواد', heading: 'کھلے طور پر دستیاب تعلیمی مواد', lead: 'مارل برج اکیڈمک ٹیم کا لکھا ہوا مطالعاتی مواد، مضمون، سطح اور موضوع کے مطابق منظم۔ پڑھنے کے لیے مفت، اور موضوع بہ موضوع شامل کیا جاتا ہے۔', englishNote: 'نیچے شائع شدہ مواد انگریزی میں ہے۔', combinationsLabel: 'مجموعہ', boardsLabel: 'بورڈ', qualificationsLabel: 'قابلیت', viewLabel: 'دیکھیں', notOffered: 'زیرِ تیاری۔' },
    bn: { title: 'শিক্ষা উপকরণ', description: 'মার্লব্রিজ একাডেমিক টিমের লেখা স্টাডি গাইড এবং রিভিশন নোট। পড়ার জন্য বিনামূল্যে, এবং বিষয়, স্তর ও টপিক অনুযায়ী সাজানো।', eyebrow: 'উপকরণ', heading: 'উন্মুক্তভাবে উপলব্ধ শিক্ষা উপকরণ', lead: 'মার্লব্রিজ একাডেমিক টিমের লেখা পড়াশোনার উপকরণ, বিষয়, স্তর ও টপিক অনুযায়ী সাজানো। পড়ার জন্য বিনামূল্যে, এবং টপিক অনুযায়ী যোগ করা হয়।', englishNote: 'নিচের প্রকাশিত উপকরণ ইংরেজিতে।', combinationsLabel: 'কম্বিনেশন', boardsLabel: 'বোর্ড', qualificationsLabel: 'যোগ্যতা', viewLabel: 'দেখুন', notOffered: 'উন্নয়নাধীন।' },
  },
  subjects: {
