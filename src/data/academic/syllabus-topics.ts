  ...
  },
  {
    ...
    topics: [
      ...
      { number: 5, name: 'Prescribed literary texts and films', slug: 'prescribed-literary-texts-and-films-9ur0', subtopics: [
        ...
        { number: '5.2', name: 'پطرس کے مضامین — احمد شاہ پطرس بخاری (2011) essays: سویرے جو کل آنکھ میری کھلی؛ اردو کی آخری کتاب؛ مرید پور کا پیر؛ مرحوم کی یاد میں؛ لاہور کا جغرافیہ', slug: 'patras-ke-mazameen-ahmed-shah-patras-bukhari-9ur0' },
        { number: '5.3', name: 'بساط — باصر کاظمی (1987) play', slug: 'bisaat-basir-kazmi-9ur0' },
        { number: '5.4', name: 'بن روئے — مومنہ درید (2015)', slug: 'bin-roye-momina-duraid-9ur0' },
