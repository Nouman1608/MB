...
export const SYLLABUS_VERSIONS: readonly SyllabusVersion[] = [
  ...
  },
  {
    ...
    topics: [
      { number: 1, name: 'پاکستانی معاشرے کا ارتقا', slug: 'theme-1-evolving-pakistani-society-9ur0', subtopics: [
        ...
        { number: '1.3', name: 'تعلیم', slug: 'taleem-education-research-subject-9ur0' },
      ] },
      { number: 2, name: 'اردو بولنے والی دنیا میں تمدن اور فنونِ لطیفہ', slug: 'theme-2-art-and-culture-urdu-speaking-world-9ur0', subtopics: [
      ...
      { number: 4, name: 'پاکستانی سیاست کے رُخ', slug: 'theme-4-aspects-of-pakistani-politics-9ur0', subtopics: [
        { number: '4.1', name: 'قیام پاکستان (1947)', slug: 'qiyam-e-pakistan-1947-9ur0' },
  ...
  },
  {
    ...
    notes: "Rebuilt 2026-09-17 (D-263, E939 (3)) from the '3 Approaches to teaching and learning' section, 'Topic list' (Version 2, April 2025; printed p.12, PDF fetched and rendered as an image to read the two-column list). The syllabus states 'Knowledge of content is not assessed in this syllabus' and 'The topic list is for all components' — these 22 topics are an open list students and teachers choose from as a stimulus for developing skills (research, analysis, evaluation, reflection, communication and collaboration), not graded content, but they are the syllabus's own subject-content heading and replace the previous three-component entry per the E939 (3) finding. The syllabus prints the list alphabetically in two unnumbered columns with no topic numbers; the numbers below are Marlbridge's own sequential ordinals (alphabetical order, matching the syllabus's own ordering), not the syllabus's. No syllabus subtopics exist beneath any topic. The Version 2 syllabus update PDF (674932-2025-2027-syllabus-update.pdf) confirms Version 2 only clarified Component 1 skills wording; the topic list is unchanged from Version 1. The newer 0457 2028 syllabus (744776-2028-syllabus.pdf, Version 1, September 2025) prints the same 22 topics and states 'no significant changes' from this series; this entry is not renamed to cover it, since effectiveTo 2027 already scopes this record to the current 2025-2027 series.",
    topics: [
