...
export const SYLLABUS_VERSIONS: readonly SyllabusVersion[] = [
...

  {
    ...
    effectiveFrom: '2016', effectiveTo: 'ongoing', status: 'current',
    tiered: false,
    source: 'OxfordAQA -- official International GCSE Biology (9201) specification PDF, Version 5.2 (topic and sub-topic names re-checked against it, 2026-09-08)',
...

  {
    ...
    effectiveFrom: '2016', effectiveTo: 'ongoing', status: 'current',
    tiered: false,
    source: 'OxfordAQA -- official International GCSE Chemistry (9202) specification PDF, Version 6.2 (topic and sub-topic names re-checked against it, 2026-09-08)',
  ...
  },
{
    ...
    effectiveFrom: '2019', effectiveTo: 'current', status: 'current',
    tiered: false,
    source: 'OxfordAQA International AS and A-level Chemistry (9620) specification, Version 5.3, Section 3 Subject content (all 87 sub-topic names re-checked against it, 2026-09-08)',
...
export const KNOWN_OTHER_SERIES = [
  ...
  { syllabusCode: '9489', syllabusSeries: '2026', status: 'superseded' as const,
    ...
    notes: 'Version 3 (December 2025). Superseded on the site by 2027-2029 from 2026-09-17 (I396 rebuild, D-264), but still examined in the November 2026 series, its final series. Its AS options each had four topics (the Industrial Revolution in Britain and China and Japan among them) and Paper 4 had four International depth-study topics, all replaced in the 2027-2029 syllabus.' },
