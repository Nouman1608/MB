...
export const SYLLABUS_VERSIONS: readonly SyllabusVersion[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      { number: 5, name: 'Chemical energetics', slug: 'as-chemical-energetics', stage: 'AS', subtopics: [{ number: '5.1', name: 'Enthalpy change,', slug: 'as-enthalpy-change' }, { number: '5.2', name: 'Hess', slug: 'as-hess' }] },
      ...
      { number: 7, name: 'Equilibria', slug: 'as-equilibria', stage: 'AS', subtopics: [{ number: '7.1', name: 'Chemical equilibria', slug: 'as-chemical-equilibria' }] },
      { number: 8, name: 'Reaction kinetics', slug: 'as-reaction-kinetics', stage: 'AS', subtopics: [{ number: '8.1', name: 'Rate of reaction', slug: 'as-rate-of-reaction' }, { number: '8.2', name: 'Effect of temperature on reaction rates and the concept of', slug: 'as-effect-of-temperature-on-reaction-rates-and-the-concept-of' }, { number: '8.3', name: 'Homogeneous and heterogeneous catalysts', slug: 'as-homogeneous-and-heterogeneous-catalysts' }] },
      { number: 9, name: 'The Periodic Table: chemical periodicity', slug: 'as-the-periodic-table-chemical-periodicity', stage: 'AS', subtopics: [{ number: '9.1', name: 'Periodicity of physical properties of the elements in Perio', slug: 'as-periodicity-of-physical-properties-of-the-elements-in-perio' }, { number: '9.2', name: 'Periodicity of chemical properties of the elements in Perio', slug: 'as-periodicity-of-chemical-properties-of-the-elements-in-perio' }, { number: '9.3', name: 'Chemical periodicity of other elements', slug: 'as-chemical-periodicity-of-other-elements' }] },
      { number: 10, name: 'Group 2', slug: 'as-group-2', stage: 'AS', subtopics: [{ number: '10.1', name: 'Similarities and trends in the properties of the Group 2 me', slug: 'as-similarities-and-trends-in-the-properties-of-the-group-2-me' }] },
      { number: 11, name: 'Group 17', slug: 'as-group-17', stage: 'AS', subtopics: [{ number: '11.1', name: 'Physical properties of the Group 17 elements', slug: 'as-physical-properties-of-the-group-17-elements' }, { number: '11.2', name: 'The chemical properties of the halogen elements and the hyd', slug: 'as-the-chemical-properties-of-the-halogen-elements-and-the-hyd' }, { number: '11.3', name: 'Some reactions of the halide ions', slug: 'as-some-reactions-of-the-halide-ions' }, { number: '11.4', name: 'The reactions of chlorine', slug: 'as-the-reactions-of-chlorine' }] },
      ...
      { number: 13, name: 'An introduction to AS Level organic chemistry', slug: 'as-an-introduction-to-as-level-organic-chemistry', stage: 'AS', subtopics: [{ number: '13.1', name: 'Formulas, functional groups and the naming of organic compo', slug: 'as-formulas-functional-groups-and-the-naming-of-organic-compo' }, { number: '13.2', name: 'Characteristic organic reactions', slug: 'as-characteristic-organic-reactions' }, { number: '13.3', name: 'Shapes of organic molecules', slug: 'as-shapes-of-organic-molecules' }, { number: '13.4', name: 'Isomerism', slug: 'as-isomerism' }] },
      ...
      { number: 24, name: 'Electrochemistry', slug: 'a-electrochemistry', stage: 'A', subtopics: [{ number: '24.1', name: 'Electrolysis', slug: 'a-electrolysis' }, { number: '24.2', name: 'Standard electrode potentials E', slug: 'a-standard-electrode-potentials-e' }] },
      ...
      { number: 26, name: 'Reaction kinetics', slug: 'a-reaction-kinetics', stage: 'A', subtopics: [{ number: '26.1', name: 'Simple rate equations, orders of reaction and rate constant', slug: 'a-simple-rate-equations-orders-of-reaction-and-rate-constant' }, { number: '26.2', name: 'Homogeneous and heterogeneous catalysts', slug: 'a-homogeneous-and-heterogeneous-catalysts' }] },
      { number: 27, name: 'Group 2', slug: 'a-group-2', stage: 'A', subtopics: [{ number: '27.1', name: 'Similarities and trends in the properties of the Group 2 me', slug: 'a-similarities-and-trends-in-the-properties-of-the-group-2-me' }] },
      { number: 28, name: 'Chemistry of transition elements', slug: 'a-chemistry-of-transition-elements', stage: 'A', subtopics: [{ number: '28.1', name: 'General physical and chemical properties of the first row o', slug: 'a-general-physical-and-chemical-properties-of-the-first-row-o' }, { number: '28.2', name: 'General characteristic chemical properties of the first set', slug: 'a-general-characteristic-chemical-properties-of-the-first-set' }, { number: '28.3', name: 'Colour of complexes', slug: 'a-colour-of-complexes' }, { number: '28.4', name: 'Stereoisomerism in transition element complexes', slug: 'a-stereoisomerism-in-transition-element-complexes' }, { number: '28.5', name: 'Stability constants, Kstab', slug: 'a-stability-constants-kstab' }] },
      { number: 29, name: 'An introduction to A Level organic chemistry', slug: 'a-an-introduction-to-a-level-organic-chemistry', stage: 'A', subtopics: [{ number: '29.1', name: 'Formulas, functional groups and the naming of organic compo', slug: 'a-formulas-functional-groups-and-the-naming-of-organic-compo' }, { number: '29.2', name: 'Characteristic organic reactions', slug: 'a-characteristic-organic-reactions' }, { number: '29.3', name: 'Shapes of aromatic organic molecules', slug: 'a-shapes-of-aromatic-organic-molecules' }, { number: '29.4', name: 'Isomerism', slug: 'a-isomerism' }] },
