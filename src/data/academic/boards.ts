...
export const BOARDS: readonly Board[] = [
  ...
  },
  {
    ...
    status: 'offered',
    source: 'https://learnersacademy.com.pk/ (nav + "Which exam boards do you teach?" FAQ)',
    about: 'AQA (the Assessment and Qualifications Alliance) is a UK domestic awarding body, offering GCSE and GCE A Level qualifications to schools in England. It is a separate organisation from OxfordAQA, a partnership between Oxford University Press and AQA, which is listed as its own board below.',
  },
  {
    slug: 'oxfordaqa',
    name: 'OxfordAQA',
    ...
    notes: 'A fully separate awarding body from AQA (the UK board, slug "aqa" above) despite sharing the AQA name — OxfordAQA is a partnership between Oxford University Press and AQA (oxfordaqa.com About us, read 2026-09-17), administratively and academically distinct, and is NEVER merged with, or treated as a subcategory of, plain "aqa" in this repository. Owner-authorized as an active Marlbridge teaching offering 2026-08-18 (MARLBRIDGE v1.0 directive). The qualification families recorded here are International GCSE, International AS and International A-level (OxfordAQA also offers others, e.g. the International Extended Project Qualification 9695, not modelled here) — no O Level, no UK GCSE, no UK A-level. Every combination below is independently verified against oxfordaqa.com, 2026-08-18; a prior code-snapshot table was explicitly not trusted and every code was re-fetched from the live qualification page. See matrix.ts for full per-row evidence and source URLs.',
    about: 'OxfordAQA is a partnership between Oxford University Press and AQA (the UK board listed separately above) -- a distinct examining body from AQA despite the shared name. Aimed at schools outside the UK, it offers International GCSE, International AS and International A-level qualifications, as well as others such as the International Extended Project Qualification (9695).',
  },
  {
    slug: 'ocr',
    name: 'OCR',
    ...
    about: 'OCR ("Cambridge OCR") is a UK-domestic awarding body, part of Cambridge University Press & Assessment -- administratively distinct from Cambridge International (the "cambridge" board above), despite sharing a parent organisation. OCR offers UK GCSE and GCE AS and A Level qualifications, alongside others such as Cambridge Nationals, Cambridge Technicals and Entry Level; it does not offer O Level or IGCSE.',
  },
  {
    slug: 'ib',
