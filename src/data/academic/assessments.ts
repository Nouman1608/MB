...
export interface Assessment {
  ...
  /**
   * Reader-facing label, shown next to the component table, saying which
   * figures in this record were NOT read from a document the board itself
   * publishes (owner decision 2026-09-21, U77: label rather than remove).
   * Set only where that is true; the hub and the syllabus-updates tracker
   * both render it.
   */
  readonly marksSourceNote?: string;
...
export const ASSESSMENTS: readonly Assessment[] = [
  ...
  },
  {
    ...
    firstAssessment: '2026',
    components: [
      { paperCode: 'Paper 1', title: 'Paper 1', durationMinutes: 90, marks: 50, weightingPercent: 50, assessmentType: 'written-exam' },
  ...
  },
  {
    ...
    notes: 'A genuinely route-based specification, per the official PDF\'s "Structure of AS Level and A Level Mathematics" table (Syllabus overview, pp.14-16) and Assessment overview (p.14, re-read 2026-09-17 for the AS weightings below). Full A Level is always Paper 1 + Paper 3 (both compulsory, 30%+30%=60%) + Paper 5 Probability & Statistics 1 (compulsory, 20%) + EITHER Paper 4 Mechanics OR Paper 6 Probability & Statistics 2 (each 20%, mutually exclusive -- Paper 6 cannot be combined with Paper 4 because it depends on Paper 5 content) -- shown here as alternatives, so the total is exactly 100%. Paper 2 Pure Mathematics 2 does NOT count toward the A Level at all (shown here with a weighting of 0%) -- it exists only for the separate standalone "AS Level, Pure Mathematics only" route (Paper 1 + Paper 2), "Offered only as part of AS Level" (p.14). AS Level is instead Paper 1 (60% of the AS Level) + ONE of {Paper 2, Paper 4, Paper 5} (each 40% of the AS Level; only Papers 1+4 or 1+5 can be carried forward as the first stage of a staged A Level) -- the AS weightings and alternatives are shown separately, so an AS route also sums to exactly 100%. Paper 3 and Paper 6 carry no AS weighting: Paper 3 is "Compulsory for A Level" only (not offered at AS at all) and Paper 6 is "Offered only as part of A Level" (p.15) -- neither has any AS-route figure to show. Durations/marks per paper (all externally assessed written exams): Paper 1 1h50/75 marks, Paper 2 1h15/50 marks, Paper 3 1h50/75 marks, Papers 4-6 each 1h15/50 marks. Examination-series window 2026-2027 (June, November, and March-in-India series); no separate first-teaching date published.',
  ...
  },
  {
    ...
    firstAssessment: '2026',
    components: [
      { paperCode: 'Paper 1', title: 'Paper 1', durationMinutes: 90, marks: 50, weightingPercent: 50, assessmentType: 'written-exam', externallyAssessed: true },
  ...
  },
  {
    ...
    verifiedOn: '2026-08-27',
    notes: 'Directly confirmed against the official PDF\'s "Component/Weighting" table (Syllabus overview, p.13): Papers 1-4 each 1h30/60 marks, weighted 25% each of the full A Level (Papers 1+2 are 50% each of the AS Level route instead, not separately modeled here -- see the board\'s own table for exact AS-route figures). Unlike the other syllabuses on this site, this PDF does not use the phrase "Externally assessed" anywhere for any component, so this record does not mark any component as externally assessed rather than infer it. A Level candidates follow a staged route: Papers 1+2 (AS Level) in one series, then Papers 3+4 (completing the A Level) in a later series.',
  ...
  },
  {
    ...
    firstAssessment: '2027',
    components: [
      { paperCode: 'Paper 1', title: 'Multiple Choice', durationMinutes: 90, marks: 40, weightingPercent: 30, assessmentType: 'multiple-choice', externallyAssessed: true, calculatorAllowed: true },
    ...
    officialSourceUrl: 'https://www.cambridgeinternational.org/Images/718141-2027-2029-syllabus.pdf',
    verifiedOn: '2026-09-16',
    notes: 'Directly confirmed against the 2027-2029 syllabus PDF (Version 1; Assessment overview, p.9, and Details of the assessment, p.22): Paper 1 Multiple Choice (1h30, 40 marks, 30%, all 40 questions answered) and Paper 2 Structured Written Paper (1h45, 100 marks, 70%, five compulsory 20-mark questions), both externally assessed, calculators permitted in both. Not tiered. Exam series 2027, 2028 and 2029 (June and November, and March in India). The 2026 edition (Paper 1: 1h15, 35 marks) is still examined in November 2026, its final series.',
    assessmentModel: 'linear',
  },
  {
    boardSlug: 'cambridge',
  ...
  },
  {
    ...
    verifiedOn: '2026-08-27',
    notes: 'Directly confirmed against the official PDF (Assessment overview, p.9): Paper 1 Short Answer and Data Response (1h30, 80 marks, 50%, four questions) and Paper 2 Case Study (1h30, 80 marks, 50%, four questions based on a case-study insert), both externally assessed, all questions compulsory. This is a single-year syllabus edition (2026), not tiered. Examination-series window 2026 (June, November, and March-in-India series); no separate first-teaching date published. Cambridge has changed the syllabus code to 0264 (Cambridge IGCSE Business) for first assessment in March 2027, so 2026 is the last examination year for 0450. Re-classified \'legacy-teach-out\' on 2026-09-17: the 0450 qualification page carries the notice \'New syllabus name and code for first assessment March 2027\', and 0264 (Cambridge IGCSE Business) is recorded separately; 0450\'s own final examination year is 2026.',
    assessmentModel: 'linear',
  },
  {
    boardSlug: 'cambridge',
    ...
    officialSourceUrl: 'https://www.cambridgeinternational.org/Images/718123-2027-2029-syllabus.pdf',
    verifiedOn: '2026-09-17',
    notes: 'Added 2026-09-17 so the 0450 changeover is recorded on both sides. Read from the official 0264 syllabus PDF (Version 2, published March 2025), Assessment overview: \'All candidates take two papers. Candidates will be eligible for grades A* to G\'; Paper 1 Short Answer and Data Response, 1 hour 30 minutes, 80 marks, 50%, \'Four questions requiring a mixture of short answers and structured data responses\'; Paper 2 Case Study, 1 hour 30 minutes, 80 marks, 50%, \'Four questions based on a case study, provided as an insert with the paper\'; both externally assessed, all questions compulsory. The syllabus is for exams in 2027, 2028 and 2029, available in the June and November series and in the March series in India, so the first assessment is in 2027 (the March 2027 India series is the first). It gives no first-teaching date, and none is recorded here; It is recorded as the current syllabus because 0450\'s final examination year is 2026, so a learner starting now follows 0264. The syllabus\'s own \'Changes to syllabus code\' section (version 1, September 2024) states: \'The syllabus name has been changed\' and \'There is a new syllabus code 0264\'.',
    assessmentModel: 'linear',
  },
  {
    boardSlug: 'cambridge',
  ...
  },
  {
    ...
    verifiedOn: '2026-08-27',
    notes: 'Same structural pattern as O Level/IGCSE Chemistry (independently re-confirmed from Physics\' own source PDF, not copied): Paper 1/3 Core (45min MCQ 30% + 1h15 Theory 50%) and Paper 2/4 Extended (identical durations/marks/weightings, different tier), plus a practical component via Paper 5 Practical Test (1h15/40 marks/20%) OR Paper 6 Alternative to Practical (1h/40 marks/20%), both externally assessed -- a candidate sits ONE of Paper 5/6, so only one counts towards the total. Core candidates eligible for grades C-G; Extended for A*-G. Directly confirmed against the official PDF (Assessment overview, p.9-10). Examination-series window 2026-2028 (June and November series); no separate first-teaching date published by Cambridge.',
    assessmentModel: 'component-based',
  },
  {
    boardSlug: 'cambridge',
  ...
  },
  {
    ...
    verifiedOn: '2026-08-27',
    notes: 'Directly confirmed against the official PDF (Assessment overview, p.9): Paper 1 Multiple Choice (45min, 30 marks, 30%, all 30 questions compulsory) and Paper 2 Structured Questions (2h15, 90 marks, 70%, one compulsory question plus three from a choice of four), both externally assessed. Not tiered; grades A*-E. This record models the single-year 2026 syllabus edition, so its first and final assessment years are both 2026; Cambridge has also published a 2027-2029 edition of 2281 (718206), which is not modeled here.',
    assessmentModel: 'linear',
  },
  {
    boardSlug: 'cambridge',
  ...
  },
  {
    ...
    verifiedOn: '2026-08-28',
    notes: 'Directly confirmed against the official PDF\'s "Assessment overview" (Syllabus overview): Paper 1 Socialisation, Identity and Methods of Research (1h30/60 marks, 50% of AS / 25% of A Level) and Paper 2 The Family (1h30/60 marks, 50% of AS / 25% of A Level) form the AS Level; Paper 3 Education (1h15/50 marks, 21% of A Level only) and Paper 4 Globalisation, Media and Religion (1h45/70 marks, 29% of A Level only) complete the full A Level. Weighting figures recorded here are the "% of A Level" figures (25+25+21+29=100, an intentionally uneven split, not a typo -- the syllabus\'s own "Changes to this syllabus" section documents that Paper 3 moved from 20% to 21% and Paper 4 from 30% to 29% in the current Version 3, published April 2026, whose overview table shows 21%/29%); the AS-only route uses the separate 50%/50% figures instead, not modeled as a distinct record. All four papers externally assessed. This is the 2024-2026 syllabus edition (June/November series, also March in India); Its final examination year is 2026.',
    assessmentModel: 'staged',
    asALevelRelationship: 'staged-cambridge-route',
  ...
  },
  {
    ...
    verifiedOn: '2026-08-28',
    notes: 'Directly confirmed against the official PDF (Assessment overview, p.9-10): all candidates take all three components (not a choice) -- Component 1 Written Exam (1h25/70 marks/35%, four compulsory source-based questions, externally assessed); Component 2 Individual Report (60 marks/30%, a 1500-2000 word report on a self-chosen global issue, described by the syllabus as "internally set and externally marked" -- recorded here as externally assessed, since Cambridge examiners do the marking); Component 3 Team Project (70 marks/35%, a collaborative Team Element plus an individually-written 750-1000 word Reflective Paper, internally assessed and externally moderated). Not tiered; grades A*-G. Examination-series window 2025-2027.',
    assessmentModel: 'component-based',
  },
  {
    boardSlug: 'cambridge',
  ...
  },
  {
    ...
    officialSourceUrl: 'https://www.cambridgeinternational.org/Images/718208-2027-2029-syllabus.pdf',
    verifiedOn: '2026-09-21',
    notes: 'Directly confirmed against the 2027-2029 syllabus (Version 1, © September 2024): Assessment overview (p.9) and Details of the assessment (p.36). Paper 1 Principles of Environmental Management (1h45/80 marks/50%, short-answer and structured questions with extended response questions based on source material) and Paper 2 Environmental Management in Context (1h45/80 marks/50%, short-answer, data processing and analysis, and extended response questions based on source material), both externally assessed, candidates answer all questions. Not tiered; grades A*-E. AO weightings (p.11): AO1 43%, AO2 30%, AO3 27% of the qualification. Exams in the June series, and in the November series in Mauritius only. This record models the 2027-2029 edition from 2026-09-21. The 2025-2026 edition (664483, Version 2) is still examined in the November 2026 series in Mauritius, its final sitting: there Paper 1 is Theory (Section A 20 marks, Section B 60 marks) and Paper 2 is Management in context, with the same durations, marks and weightings (p.9 of that syllabus).',
    assessmentModel: 'linear',
  },
  {
    boardSlug: 'cambridge',
  ...
  },
  {
    ...
    verifiedOn: '2026-08-28',
    notes: 'Directly confirmed against the official PDF (Specification Issue 7, August 2025): students complete Component 1 (compulsory) plus EITHER Component 2 OR Component 3 -- both alternatives carry identical marks (60) and weighting (40%), so they are shown as simple alternatives (unlike Cambridge 0475\'s routes, whose weightings differ). Component 1 (2h15, 90 marks, 60%): Section A Reading (45 marks, non-fiction text response) + Section B Transactional Writing (45 marks). Component 2 (1h30, 60 marks, 40%, externally assessed written exam): Section A Reading essay (30 marks) + Section B Imaginative Writing (30 marks). Component 3 (60 marks, 40%, internally assessed and externally moderated non-examined assessment): the coursework alternative to Component 2, covering the same content. Pearson also lists a separate modular version (4XEA1, first teaching September 2025; not described in this specification), which is not modeled here. First teaching September 2016, first examination June 2018.',
    assessmentModel: 'component-based',
  },
  {
    boardSlug: 'edexcel',
  ...
  },
  {
    ...
    verifiedOn: '2026-08-28',
    notes: 'Directly confirmed against the official PDF (Specification Issue 2, November 2017): tiered qualification. Foundation tier: Paper 1F + Paper 2F, each 2h/100marks/50%, targeted at grades 5-1. Higher tier: Paper 1H + Paper 2H, each 2h/100marks/50%, targeted at grades 9-4 with grade 3 allowed. All four papers externally assessed and calculator-required (a scientific electronic calculator meeting a minimum function spec). Pearson also lists a separate modular version (first teaching 2024; not described in this specification) and it is not modeled here, since this site\'s record for this combination is keyed to the established Specification A code 4MA1.',
    assessmentModel: 'linear',
  },
  {
    boardSlug: 'edexcel',
    ...
    verifiedOn: '2026-08-28',
    notes: 'Directly confirmed against the official PDF (Specification Issue 3, April 2019 -- verified this IS the current spec, distinct from and superseding the older 2013 C12/C34-numbered spec that a search initially surfaced). Every unit: externally assessed, 1h30 written exam, 75 marks, 16⅔% (16.67) of the full IAL. The full International Advanced Level (YMA01) = the four compulsory Pure Mathematics units P1-P4 PLUS exactly one pair of applied units chosen from five named valid pairs: M1+S1, M1+D1, M1+M2, S1+D1, or S1+S2 (confirmed verbatim from the spec\'s own IAS/IAL combinations table). This is shown as a set of routes (as for Cambridge IGCSE Literature in English 0475): each of the five applied units (M1, S1, D1, M2, S2) is tagged with every named route it can belong to, so e.g. M1 carries all three routes it appears in. Every route sums to 4×16.67 + 2×16.67 = 100.02%, which is 100% once each unit\'s rounded one-sixth share is allowed for. The separate International Advanced Subsidiary (IAS, code XMA01: P1+P2 plus ONE applied unit, three units total) is a different combination and is not shown here, since this site does not record the IAS separately. Further Pure Mathematics units (FP1-FP3) and the M3/S3 units belong to the separate Further Mathematics (YFM01) and Pure Mathematics (YPM01) awards and are out of scope for this record.',
  ...
  },
  {
    ...
    notes: 'Directly confirmed against the official PDF (Specification Issue 4, November 2021): not split into separate IAS/IAL stages -- two compulsory papers, both taken in the same series (June only), each 3h, 100 marks, 50%, externally assessed. Paper 1 (Underlying Principles of Law and the English Legal System) covers the nature, purpose of and liability in law, and the sources of law; Paper 2 (The Law in Action) covers the market (the law of contract), the criminal offender (criminal law) and the individual (freedom of speech and defamation, human rights, privacy, occupiers\' liability and trespass to land). First teaching September 2015, first examination June 2017.',
  ...
  },
  {
    ...
    firstAssessment: '2019',
    components: [
      { paperCode: '8132/1', title: 'Paper 1: Influences of operations and HRM on business activity', durationMinutes: 105, marks: 90, weightingPercent: 50, assessmentType: 'written-exam', externallyAssessed: true },
  ...
  },
  {
    ...
    verifiedOn: '2026-08-28',
    notes: 'Read on AQA\'s own specification-at-a-glance and scheme-of-assessment pages on 2026-09-21 (first-teaching year from the specification\'s own title there): linear, tiered Foundation (grades 1-5) / Higher (grades 4-9), each tier sits three written papers -- Paper 1 non-calculator, Papers 2-3 calculator-allowed -- each 1h30/80marks, each 33\u2153% (33.33) of GCSE, total 240 marks per tier. Assessed 100% by written examination; no coursework, controlled assessment or non-exam assessment. First teaching September 2015, first examination June 2017.',
    assessmentModel: 'linear',
  },
  {
    boardSlug: 'aqa',
    ...
    verifiedOn: '2026-08-28',
    notes: 'Read on AQA\'s own specification-at-a-glance and scheme-of-assessment pages on 2026-09-21 (first-teaching year from the specification\'s own title there): linear, not tiered, two written papers, each 1h45/100marks/50% of GCSE. Paper 1 (Cognition and behaviour) and Paper 2 (Social context and behaviour), both externally assessed with no coursework or controlled assessment. First teaching September 2017, first examination June 2019.',
    assessmentModel: 'linear',
  },
  {
    boardSlug: 'aqa',
  ...
  },
  {
    ...
    verifiedOn: '2026-08-28',
    notes: 'Directly confirmed against the official AQA specification-at-a-glance page, which for this subject is a specification UPDATED for first teaching September 2025 (spec PDF dated 08 Oct 2025) -- AQA\'s own page banner states \'first AS exams in 2026 and A-level in 2027\'; The first assessment shown is the A-level series (2027), not the AS series. Linear, not tiered, three written papers, each 2h/96marks/33⅓% (recorded as 33.34% on the third paper so the total sums to exactly 100). Papers 1 and 3 are each split into four 24-mark sections and Paper 2 into three sections (24, 24 and 48 marks), every section mixing multiple choice, short answer and extended writing. Paper 1 (compulsory content: Social influence, Memory, Attachment, Clinical Psychology and Mental Health). Paper 2 (compulsory content: Approaches in Psychology, Biopsychology, Research methods). Paper 3 (compulsory Issues and debates in Psychology, plus one topic from each of three option groups: Relationships/Gender/Cognition and development; Schizophrenia/Eating behaviour/Stress; Aggression/Forensic Psychology/Addiction). Total 288 marks. This record has not independently verified whether the pre-2025 version of 7182 differed in structure; only the current live specification-at-a-glance page was consulted.',
    assessmentModel: 'linear',
  },
  {
    boardSlug: 'aqa',
  ...
  },
  {
    ...
    verifiedOn: '2026-08-28',
    notes: 'Directly confirmed against the official AQA specification PDF (\'AS and A-level Business AS (7137) A-level (7138) Specification\', Version 1.1, November 2025): linear, not tiered. Paper 1 (Unit 3.1: What is business? Managing marketing and finance): 2h, 90 marks, 33.3% of A-level (recorded as 33.33% here) -- two case studies, each followed by five compulsory questions worth 45 marks. Paper 2 (Unit 3.2: Managing people and operations, with links to Unit 3.1): 2h, 90 marks, 33.3% (33.33% here) -- same two-case-study format. Paper 3 (Unit 3.3: Business and society, business and the external environment, and business strategy, with links to Units 3.1/3.2): 2h, 90 marks, 33.3% (recorded as 33.34% here so the total sums to exactly 100). Total 270 marks (raw marks scaled ×1). Replaces 7132: for teaching from September 2026 onwards, first A-level exams June 2028. 7132 continues to be examined through summer 2027 for cohorts already partway through. 7138 has been taught from September 2026 and is recorded here as the current specification, replacing 7132.',
    assessmentModel: 'linear',
  },
  {
    boardSlug: 'aqa',
    ...
    verifiedOn: '2026-08-28',
    notes: 'Directly confirmed against the official AQA specification PDF (\'AS and A-level Business AS (7137) A-level (7138) Specification\', Version 1.1, November 2025): linear, not tiered, two compulsory written papers, each 1h45/80marks/50% of AS. Paper 1 (Unit 3.1: What is business? Managing marketing and finance): two case studies, each followed by six compulsory questions worth 40 marks in total. Paper 2 (Unit 3.2: Managing people and operations, with links to Unit 3.1): same two-case-study format. Total 160 marks (raw marks scaled ×1). Replaces 7131: for teaching from September 2026 onwards, first AS exams June 2027. 7131 was last examined in summer 2026. 7137 has been taught from September 2026 and is recorded here as the current specification, replacing 7131.',
    assessmentModel: 'linear',
  },
  {
    boardSlug: 'ocr',
  ...
  },
  {
    ...
    officialSourceUrl: 'https://www.ocr.org.uk/Images/234600-specification-accredited-gcse-gateway-science-suite-physics-a-j249.pdf',
    verifiedOn: '2026-09-17',
  ...
  },
  {
    ...
    verifiedOn: '2026-08-28',
    notes: 'Directly confirmed against the official live "Assessment" section: a modular qualification of four units. Two AS units (P1, PSM1) each worth 50% of AS-level/20% of A-level; one compulsory A2 unit (P2, 37.5% of A-level); and a final A2 unit chosen between Statistics (S2) or Mechanics (M2), each worth 22.5% of A-level, shown as alternatives since the two options are mutually exclusive and equally weighted. Units resittable any number of times, best result counts. First teaching September 2017; first AS exams May/June 2018; first A-level exams May/June 2019.',
    assessmentModel: 'modular',
  },
  {
    boardSlug: 'oxfordaqa',
  ...
  },
  {
    ...
    verifiedOn: '2026-08-28',
    notes: 'Directly confirmed against the official live "Assessment" section of the retained legacy qualification page, which now states only the wind-down window rather than the original first-assessment date: "the final May/June exams for AS will be in 2026, and for A2 in 2027. Re-sits will be available for AS in January 2027, and for A2 in January 2028. There will be no exams for this specification (9625) after January 2028." The first assessment year shown (2020) is inferred from this specification\'s first-teaching date (September 2018) plus the standard two-year AS/A2 cycle observed consistently across every other OxfordAQA modular A-level in this dataset, since the source page itself no longer restates the original first-exam year. Re-classified \'legacy-teach-out\' on 2026-09-17: 9725 teaching began in September 2026, and 9625\'s final May/June AS series was 2026, leaving only A2 assessment (final May/June 2027) and resits (AS January 2027, A2 January 2028). Four papers: two AS papers at 20% of A-level each, two A2 papers at 30% each.',
    assessmentModel: 'modular',
  },
  {
    boardSlug: 'oxfordaqa',
    ...
    verifiedOn: '2026-08-28',
    notes: 'Directly confirmed against the official live "Assessment" section of the revised specification page: "available for first teaching from September 2026, with first AS exams in May/June 2027 and first A2 exams in May/June 2028." Four units: two AS units at 20% of A-level each, two A-level units at 30% each. It is recorded as the current specification as of 2026-09-17: first teaching began in September 2026; the legacy 9625 specification is in teach-out for cohorts completing it. Following teacher feedback, each A2 paper has separate topics and a simplified, fully case-study-based structure compared with the legacy specification. The first assessment is the first International AS exam series (May/June 2027); the first International A-level exams are in May/June 2028. The specification (Version 1.0) cover confirms both: "For teaching from September 2026 onwards", "For International AS exams May/June 2027 onwards", "For International A-level exams May/June 2028 onwards".',
    assessmentModel: 'modular',
  },
  {
    boardSlug: 'oxfordaqa',
  ...
  },
  {
    ...
    verifiedOn: '2026-08-28',
    notes: 'Directly confirmed against the official live "Assessment" section: a modular qualification of four papers with two routes for the final unit. Two AS papers (20% of A-level each) and one compulsory A2 paper (Language Variation, 30%) are followed by EITHER an exam-based Language Exploration paper (Route A) OR a Non-Exam Assessment language investigation (Route B), each also 30% -- shown as two routes. First teaching September 2017; first AS exams May/June 2018; first A-level exams May/June 2019.',
    assessmentModel: 'mixed',
  },
  {
    boardSlug: 'oxfordaqa',
  ...
  },
  {
    ...
    verifiedOn: '2026-08-28',
    notes: 'Directly confirmed against the official live "Assessment" section of a brand-new specification (the page itself is titled "NEW: International GCSE Sociology (9292)" and states "For first teaching from September 2026, with first exams from May/June 2028"). Two equally weighted written papers, no coursework. First teaching began in September 2026 and OxfordAQA has no earlier International GCSE Sociology specification, so this is the current specification for this combination; no exam has been sat on it yet (first exams May/June 2028).',
    assessmentModel: 'linear',
  },
  {
    boardSlug: 'oxfordaqa',
    ...
    components: [
      ...
      { paperCode: 'A-level Unit 5', title: 'A-level Unit 5 -- People and Technology', durationMinutes: 90, marks: 50, weightingPercent: 20, assessmentType: 'written-exam', externallyAssessed: true },
    ],
    officialSourceUrl: 'https://www.oxfordaqa.com/qualifications/international-as-a-level-sociology/',
    verifiedOn: '2026-08-28',
    notes: 'Directly confirmed against the official live "Assessment" section of a brand-new specification (page titled "NEW: International AS and A-level Sociology (9690)"), stating "For first teaching from September 2026, with first AS exams from May/June 2027 and first A-level exams from May/June 2028." Five equally weighted units (20% of A-level each). First teaching began in September 2026 and there is no earlier OxfordAQA A-level Sociology specification, so this is the current specification for this combination; no exam has been sat on it yet. The first assessment is the first International AS exam series (May/June 2027); the first International A-level exams are in May/June 2028. The specification (Version 1.0) cover confirms both: "For teaching from September 2026 onwards", "For International AS exams May/June 2027 onwards", "For International A-level exams May/June 2028 onwards".',
    assessmentModel: 'modular',
  },
  {
    boardSlug: 'oxfordaqa',
  ...
  },
  {
    ...
    verifiedOn: '2026-08-28',
    notes: 'Directly confirmed against the official live "Assessment" section: linear qualification, two equally weighted papers (Reading, including English-to-Urdu translation, and Writing), no coursework. OxfordAQA\'s official title for this qualification is simply "Urdu," not "Urdu Language"; Marlbridge lists it under Urdu Language. First teaching September 2024, first examined June 2026 onwards -- already examined as of this record\'s verification date. OxfordAQA does not offer Urdu at AS or A-level.',
    assessmentModel: 'linear',
  },
  {
    boardSlug: 'aqa',
  ...
  },
  {
    ...
    verifiedOn: '2026-08-28',
    notes: 'This record is sourced from the full subject guide (economics-guide.pdf), originally accessed under a 2026-08-22 owner licensing confirmation. Figures below are read directly from that guide\'s own \'Assessment outline -- SL\' and \'Assessment outline -- HL\' tables (retrieved via the licensed PDF, cross-checked against the syllabus\'s assessment-objectives-to-component mapping in the same document). SL: Paper 1 (one extended-response question from a choice on micro- or macroeconomics, 75min, 25 marks, 30%, no calculator); Paper 2 (data-response question set on the global economy, 105min, 40 marks, 40%, calculator permitted); Internal Assessment (portfolio of three commentaries on published news extracts, no fixed sitting duration, 45 marks, 30%, internally assessed by the teacher and externally moderated by the IB). HL sits the same Paper 1 and Paper 2 (each re-weighted to 20%/30% of the HL total) plus an HL-only Paper 3 (structured, data-based policy paper drawing on the HL extension topics, 105min, 60 marks, 30%, calculator permitted), and the same portfolio Internal Assessment re-weighted to 20%. The IB publishes no numeric course code at DP level, so the course is listed as \'DP Economics\'. First assessed 2022 per the guide\'s own title page. This is one of only two IB DP subjects (with Physics) originally sourced from the full guide under that 2026-08-22 confirmation; a separate owner decision, also 2026-09-05, retired the licensing framing entirely -- no formal IB license is claimed or required -- and, independently, IB\'s own freely public specimen exam papers (real, printed mark totals, published separately from the paid subject guides) are a sufficient primary source when paired with the free subject brief, so this licensing route is no longer the only path to a complete record.',
    assessmentModel: 'component-based',
  },
  {
    boardSlug: 'ib',
    ...
    firstAssessment: '2025',
    components: [
      { paperCode: 'Paper 1', title: 'Paper 1 -- Paper 1A Multiple-choice Questions and Paper 1B Data-based Questions', durationMinutes: 90, marks: 45, weightingPercent: 36, assessmentType: 'multiple-choice', tier: 'sl', externallyAssessed: true, calculatorAllowed: true, dataBookletProvided: true },
      { paperCode: 'Paper 2', title: 'Paper 2 -- Short and Extended Response', durationMinutes: 90, marks: 55, weightingPercent: 44, assessmentType: 'written-exam', tier: 'sl', externallyAssessed: true, calculatorAllowed: true, dataBookletProvided: true },
      ...
      { paperCode: 'Paper 1', title: 'Paper 1 -- Paper 1A Multiple-choice Questions and Paper 1B Data-based Questions', durationMinutes: 120, marks: 60, weightingPercent: 36, assessmentType: 'multiple-choice', tier: 'hl', externallyAssessed: true, calculatorAllowed: true, dataBookletProvided: true },
    ...
    verifiedOn: '2026-08-28',
    notes: 'Read from the Physics guide (first assessment 2025, physics-guide.pdf, ibo.org), Assessment outline SL and HL (pp. 62-63 of the guide, PDF pp. 68-69) and External assessment details (PDF pp. 70-71), read 2026-09-17 in a browser. SL: Paper 1 (1 hour 30 minutes, 45 marks, 36%) is presented as two separate booklets completed together without interruption, "Paper 1A—25 marks • 25 multiple-choice questions on standard level material only" and "Paper 1B—20 marks • Data-based questions"; Paper 2 (1 hour 30 minutes, "Marks: 55", 44%), short-answer and extended-response questions on standard level material only; internal assessment, the scientific investigation (24 marks, 20%), internally assessed and externally moderated. HL: Paper 1 (2 hours, 60 marks, 36%), "Paper 1A—40 marks • 40 multiple-choice questions on standard level and additional higher level material" and "Paper 1B—20 marks • Data-based questions"; Paper 2 (2 hours 30 minutes, 90 marks, 44%); internal assessment as SL. Calculators permitted and a clean copy of the Physics data booklet required on both papers. Correction 2026-09-17: SL Paper 2 marks 50 to 55 and the Paper 1 titles, which had described one mixed paper, now name Papers 1A and 1B; the earlier note\'s reliance on a school revision page is withdrawn.',
    assessmentModel: 'component-based',
  },
  {
    boardSlug: 'ib',
    ...
    notes: 'Higher Level only. The freely public official specimen-paper PDF (for first examinations 2025) was read on 2026-09-04, confirming real printed mark totals for the Higher Level papers -- Paper 1 (Section 1A multiple-choice, 40 marks, and Section 1B data-based questions, 35 marks, sat together in one 2-hour session, 75 marks combined, 36% of the final grade, calculator and data booklet permitted) and Paper 2 (data-based, short-answer and extended-response questions, 2 hours 30 minutes, 80 marks, 44%, calculator and data booklet permitted) -- but the same document could not be read in full past the Higher Level Paper 2 markscheme, before reaching the Standard Level papers. Standard Level is therefore not included here rather than estimated from the Higher Level figures. The Internal Assessment (an individual scientific investigation reported as a written report, maximum 3,000 words) is marked against four criteria -- Research Design, Data Analysis, Conclusion, Evaluation -- worth 6 marks each, 24 marks total, 20% of the final grade, internally assessed by the teacher and externally moderated by the IB; this mark total was independently corroborated against a current, actively maintained third-party IB revision resource rather than read directly from the partially inaccessible primary specimen document. Weighting and duration figures throughout are read directly from the official public subject brief.',
    assessmentModel: 'component-based',
  },
  {
    boardSlug: 'ib',
    ...
    verifiedOn: '2026-09-04',
    notes: 'Higher Level only. The freely public official specimen-paper PDF (for first examinations 2025) was read on 2026-09-04, confirming real printed mark totals for the Higher Level papers -- Paper 1 (Section 1A multiple-choice, 40 marks, and Section 1B data-based questions and questions on experimental work, 35 marks, sat together in one 2-hour session, 75 marks combined, 36% of the final grade, calculator and data booklet permitted) and Paper 2 (short-answer and extended-response questions, 2 hours 30 minutes, 90 marks, 44%, calculator and data booklet permitted) -- but the same document could not be read in full past the Higher Level Paper 2 markscheme, before reaching the Standard Level papers, which the document\'s own table of contents confirms it also contains. Standard Level is therefore not included here rather than estimated from the Higher Level figures. The Internal Assessment (an individual scientific investigation reported as a written report, maximum 3,000 words) is marked against four criteria -- Research Design, Data Analysis, Conclusion, Evaluation -- worth 6 marks each, 24 marks total, 20% of the final grade, internally assessed by the teacher and externally moderated by the IB; this mark total was independently corroborated against a current, actively maintained third-party IB revision resource rather than read directly from the partially inaccessible primary specimen document. Weighting and duration figures throughout are read directly from the official public subject brief. The official source linked here is the public subject brief, which is what the component marks and weightings were checked against. Marlbridge\'s IB Chemistry study resources cite the full Chemistry guide instead, since they needed its fuller content; the two citations answer different questions.',
    assessmentModel: 'component-based',
  },
  {
    boardSlug: 'ib',
  ...
  },
  {
    ...
    marksSourceNote: 'The Paper 1 and Paper 2 totals come from IB specimen papers that Marlbridge cannot currently link to on the IB\'s own site, and the HL essay and individual oral totals from teacher resource websites. The durations and weightings match the IB\'s public subject brief.',
  ...
  },
  {
    ...
    components: [
      ...
      { paperCode: 'Paper 3', title: 'Paper 3 -- Two Extended-Response Problem-Solving Questions (HL Only)', durationMinutes: 75, marks: 55, weightingPercent: 20, assessmentType: 'written-exam', tier: 'hl', externallyAssessed: true, calculatorAllowed: true },
    ...
    verifiedOn: '2026-09-04',
    notes: 'Both tiers modeled in full. Weighting and duration are read directly from the official public subject brief (first assessments 2021). Paper 1 and Paper 2 Higher Level mark totals (110 marks each, 2 hours each) are read directly from the official freely public specimen papers, read on 2026-09-04; the same document could not be read in full far enough to confirm the Standard Level papers or Paper 3. Standard Level Paper 1/Paper 2 (80 marks each), Higher Level Paper 3 (55 marks, two compulsory extended-response problem-solving questions, technology required) and the Mathematical Exploration (20 marks at both tiers, marked against five criteria -- Presentation (4), Mathematical Communication (4), Personal Engagement (3), Reflection (3), Use of Mathematics (6) -- an internally assessed written investigation, compulsory at both tiers) were independently corroborated against a current, actively maintained third-party IB revision resource that publishes exact maximum-mark grade-boundary tables; those tables agree exactly with the primary specimen document everywhere the two overlap (Higher Level Paper 1 and Paper 2). HL Paper 3 duration: 1 hour 15 minutes, per the IB May 2026 examination schedule ("Mathematics: analysis and approaches HL paper 3 / Mathematics: applications and interpretation HL paper 3 1h 15m", read at ibo.org 2026-09-17); the subject guide (first assessment 2021, updated November 2020) and subject brief still say 1 hour and are superseded on this point for the current course.',
    assessmentModel: 'component-based',
  },
  {
    boardSlug: 'ib',
    ...
    verifiedOn: '2026-09-04',
    notes: 'Both tiers modeled in full. Weighting and duration are read directly from the official public subject brief (first assessments 2021); all external papers require technology throughout this course. Paper 1 and Paper 2 Higher Level mark totals (110 marks each, 2 hours each) are read directly from the official freely public specimen papers, read on 2026-09-04; the same document could not be read in full far enough to confirm the Standard Level papers or Paper 3. Standard Level Paper 1/Paper 2 (80 marks each), Higher Level Paper 3 (55 marks, two compulsory extended-response problem-solving questions) and the Mathematical Exploration (20 marks at both tiers, the same five-criterion structure shared with Mathematics: Analysis and Approaches) were independently corroborated against a current, actively maintained third-party IB revision resource that publishes exact maximum-mark grade-boundary tables; those tables agree exactly with the primary specimen document everywhere the two overlap (Higher Level Paper 1 and Paper 2). HL Paper 3 duration: 1 hour 15 minutes, per the IB May 2026 examination schedule ("Mathematics: analysis and approaches HL paper 3 / Mathematics: applications and interpretation HL paper 3 1h 15m", read at ibo.org 2026-09-17); the subject guide (first assessment 2021, updated November 2020) and subject brief still say 1 hour and are superseded on this point for the current course.',
    assessmentModel: 'component-based',
  },
  {
    boardSlug: 'ib',
  ...
  },
  {
    ...
    marksSourceNote: 'The mark totals shown were read from a copy of the IB\'s Business management guide hosted on a school\'s website, not from a document on the IB\'s own site. The durations and weightings match the IB\'s public subject brief.',
    ...
    notes: 'Both tiers modeled in full. Owner decision 2026-09-05 widened this site\'s evidence policy so a genuine, authentic IB-origin document is usable even when mirrored on a third-party host, not only ibo.org itself, provided the primary figures are checked for internal consistency and independently corroborated. Weighting and duration for Higher Level are read directly from the official public subject brief (first assessments 2024), read on 2026-09-05. Exact mark totals for every component at both tiers -- not published in the two-page subject brief itself -- are read from the full official subject guide\'s own "Assessment outline -- SL/HL" appendix, reproduced verbatim on an IB World School\'s own site (Anatolia College, a non-commercial school domain hosting the guide for its own community) and independently corroborated by a second, separately hosted copy of the identical official guide on another IB World School\'s site (UWC East Africa), both read on 2026-09-05. Every Higher Level figure the mirror and the official subject brief both state (all three paper weightings and durations) match exactly, giving strong confidence in the mirror\'s accuracy for the figures the brief does not itself publish (all mark totals, and the Standard Level weighting/duration, since no separate Standard Level subject brief was available when this record was compiled (2026-09-05)). Standard Level sits Paper 1 and Paper 2 plus the Business Research Project; Higher Level sits the same two papers (Paper 2 lengthened and extended to cover HL-only extension topics) plus an HL-only Paper 3 on a social enterprise, and the same Business Research Project (internally assessed, externally moderated, maximum 1,800 words, re-weighted).',
  ...
  },
  {
    ...
    marksSourceNote: 'Paper 2 is shown as 25 marks from a change for the May 2026 exams reported by a teacher resource site (thinkib.net); the IB\'s own guide (first assessment 2021) prints 30 marks. The other mark totals match that IB guide.',
  ...
  },
  {
    ...
    qualificationSlug: 'ib-dp',
    subjectSlug: 'psychology',
    code: 'DP Psychology (2019)',
    specStatus: 'legacy-teach-out',
    relatedCode: 'DP Psychology (2027)',
    tiers: ['sl', 'hl'],
    firstAssessment: '2019',
    // IB course page (ibo.org, read 2026-09-21): 'for the last assessment in 2026'.
    finalAssessment: '2026',
    components: [
      { paperCode: 'Paper 1', title: 'Paper 1 -- Three Short-Answer Questions on the Core Approaches (Biological, Cognitive, Sociocultural), Plus One Essay Chosen from Three', durationMinutes: 120, marks: 49, weightingPercent: 50, assessmentType: 'written-exam', tier: 'sl', externallyAssessed: true },
      { paperCode: 'Paper 2', title: 'Paper 2 -- One Essay Question on One Option (Abnormal, Developmental, Health, or Relationships Psychology)', durationMinutes: 60, marks: 22, weightingPercent: 25, assessmentType: 'written-exam', tier: 'sl', externallyAssessed: true },
      { paperCode: 'Internal Assessment', title: 'Internal Assessment -- Report on a Simple Experimental Study', durationMinutes: null, marks: 22, weightingPercent: 25, assessmentType: 'coursework', tier: 'sl', internallyAssessed: true, externallyModerated: true },
      { paperCode: 'Paper 1', title: 'Paper 1 -- Three Short-Answer Questions on the Core Approaches (Biological, Cognitive, Sociocultural), Plus One Essay Chosen from Three', durationMinutes: 120, marks: 49, weightingPercent: 40, assessmentType: 'written-exam', tier: 'hl', externallyAssessed: true },
      { paperCode: 'Paper 2', title: 'Paper 2 -- Two Essay Questions, One Each on Two Options (Abnormal, Developmental, Health, or Relationships Psychology)', durationMinutes: 120, marks: 44, weightingPercent: 20, assessmentType: 'written-exam', tier: 'hl', externallyAssessed: true },
      { paperCode: 'Paper 3', title: 'Paper 3 -- Three Short-Answer Questions on Approaches to Research, Based on an Unseen Stimulus (HL Only)', durationMinutes: 60, marks: 24, weightingPercent: 20, assessmentType: 'written-exam', tier: 'hl', externallyAssessed: true },
      { paperCode: 'Internal Assessment', title: 'Internal Assessment -- Report on a Simple Experimental Study', durationMinutes: null, marks: 22, weightingPercent: 20, assessmentType: 'coursework', tier: 'hl', internallyAssessed: true, externallyModerated: true },
    ],
    marksSourceNote: 'The IB\'s public subject brief for this course gives durations and weightings but no marks. The Paper 1, Paper 2 and Paper 3 totals shown were read from copies of May 2019 IB markschemes found on third-party websites (for Paper 2, a mirror copy of the May 2019 Paper 2 markscheme); and the internal assessment\'s 22 marks came from third-party teacher resources. None was read from a document published by the IB.',
    officialSourceUrl: 'https://www.ibo.org/contentassets/5895a05412144fe890312bad52b17044/psychology-sl-hl-2019-en.pdf',
    verifiedOn: '2026-09-08',
    notes: 'Both tiers modeled in full, for the psychology course first assessed in 2019. Recorded as being taught out from 2026-09-17: the new course (code \'DP Psychology (2027)\') has been taught since August 2025, so a new student follows that one, and this course is examined for learners already partway through it; the IB\'s own DP psychology page summarizes this course "for the last assessment in 2026" (read on 2026-09-21), so 2026 is recorded as its last examination year. The same rule is applied to AQA 7137/7138, OCR H436 and OxfordAQA 9725: a specification is current once its first teaching has begun. Weighting and duration figures are read directly from the IB\'s own official public subject brief (First assessment 2019), read on 2026-09-08. Mark totals -- not published in that subject brief -- were independently confirmed against real, genuine IB markschemes read on 2026-09-08: Paper 1 (M19/3/PSYCH/SP1) totals 49 marks (Section A: three compulsory short-answer questions on the biological, cognitive and sociocultural approaches, 9 marks each = 27; Section B: one essay chosen from three, 22 marks), identical for SL and HL. Paper 2 (option paper) is one essay marked out of 22 at SL (one question) or two essays marked out of 22 each = 44 at HL (two questions) -- this figure was confirmed earlier from a mirror copy of the May 2019 Paper 2 markscheme and is repeated here, not re-derived. Paper 3 (M19/3/PSYCH/HP3, HL only) totals 24 marks (Q1 a/b/c: 3+3+3=9; Q2: 6; Q3: 9). The Internal Assessment (a report on a simple experimental study, word-limited, undertaken individually) is marked against four criteria -- Introduction (6), Exploration (4), Analysis (6), Evaluation (6) -- 22 marks total, both tiers; this breakdown and total were corroborated across multiple independently-authored third-party IB teacher/revision resources and cross-checked against a real, dated (May 2019) subject-report account of the same four criterion names, rather than read from a single source alone. A genuine discrepancy was found and resolved during sourcing: an older, pre-2019-revision IA rubric (9 criteria A-I, 34 marks total) exists online and was initially mistaken for this syllabus\'s rubric before the dated May-2019 subject report confirmed the correct (4-criterion, 22-mark) structure actually in use for first assessment 2019 -- the 34-mark rubric belongs to an earlier, already-superseded revision of this same legacy course and is not used here.',
    internalNotes: 'Closes the gap flagged in the \'DP Psychology (2027)\' record\'s own internalNotes (D-129 batch, 2026-09-05): that session sourced Paper 2\'s marks for this syllabus but explicitly left Paper 1 and Paper 3 unconfirmed due to time budget. This session fetched official IB markschemes directly (papacambridge.com mirrors of genuine M19/3/PSYCH/SP1 and M19/3/PSYCH/HP3 documents, confirmed as real IB markscheme content by their formatting, IB copyright notices and paper codes, not just search-engine summaries) for both, plus the official 2019 subject brief PDF (ibo.org) for weighting/duration, plus multiple independent secondary sources for the IA mark breakdown (cross-checked against each other and against a dated May-2019 IB Psychology subject report before settling the 22-vs-34-mark discrepancy in the text above). sourceConfidence/mirrorSourceUrl intentionally omitted: every mark total was verified against the primary IB markscheme document itself, not a third-party estimate.',
    assessmentModel: 'component-based',
  },
  {
    boardSlug: 'ib',
    ...
    verifiedOn: '2026-09-05',
    notes: 'Both tiers modeled in full, for the NEW psychology course (launched February 2025, first teaching August 2025, first assessment May 2027). Recorded as current from 2026-09-17: teaching began in August 2025, so it is the course a new student follows, although its first exams have not been sat; the same rule is applied to AQA 7137/7138, OCR H436 and OxfordAQA 9725. Every figure below, including full mark totals for every component, is read directly from the IB\'s own official curriculum-updates page for this subject, which reproduces the new course\'s complete assessment-outline tables in full (no mirror or third-party source was needed). The earlier syllabus (first assessment 2019, being taught out) is modeled separately as its own \'legacy-teach-out\' record (code \'DP Psychology (2019)\', added 2026-09-08), so both courses are now recorded. Standard Level sits Paper 1 (integration of concepts/content/contexts) and Paper 2 (applying concepts to research contexts, including the four class practicals); Higher Level sits the same two papers (re-weighted) plus an HL-only Paper 3 on interpretation and analysis of research data, since data analysis and interpretation is studied by both levels but assessed only at HL. The Internal Assessment (a research proposal designed using one of four research methods practised in class, 24 marks both tiers) is internally assessed by the teacher and externally moderated by the IB.',
    internalNotes: 'D-129 batch. Subject-specific transition-awareness note from the task brief applied directly: confirmed via ibo.org\'s own psychology-updates page that a genuine two-syllabus transition is underway (old: first assessment 2019; new: first assessment 2027) -- this is the same pattern as ESS/Global Politics/Computer Science. Chose to model ONLY the new/future syllabus because it is the one with complete, OFFICIAL_HOST-sourced marks; did not extend research to source the old syllabus\'s marks (a real M19/3/PSYCH/BP2 markscheme mirror was found confirming that syllabus\'s Paper 2 uses a 22-mark-per-question criterion scale, SL sits one question=22 total marks, HL sits two=44 total marks, but Paper 1 and Paper 3 marks for that old syllabus were not independently confirmed this session) due to time budget -- flagged as a real gap, not silently dropped. sourceConfidence/mirrorSourceUrl intentionally omitted: every fact came directly from ibo.org itself. UPDATE 2026-09-08: the flagged gap is now closed -- see the new \'DP Psychology (2019)\' current record, whose own internalNotes document the fresh sourcing for Paper 1 (49 marks) and Paper 3 (24 marks).',
    assessmentModel: 'component-based',
  },
  {
    boardSlug: 'ib',
    ...
    marksSourceNote: 'The mark totals shown come from teacher resource websites, not from a document published by the IB, and the Higher Level totals rest mainly on one of them. The durations and weightings match the IB\'s public subject brief.',
    officialSourceUrl: 'https://www.ibo.org/globalassets/new-structure/university-admission/pdfs/environmental-systems-and-societies-subject-brief-en.pdf',
    verifiedOn: '2026-09-05',
  ...
  },
  {
    ...
    components: [
      ...
      { paperCode: 'Paper 2', title: 'Paper 2 -- Extended Response on the Thematic Studies', durationMinutes: 105, marks: 30, weightingPercent: 40, assessmentType: 'written-exam', tier: 'sl', externallyAssessed: true },
      ...
      { paperCode: 'Paper 2', title: 'Paper 2 -- Extended Response on the Thematic Studies', durationMinutes: 105, marks: 30, weightingPercent: 30, assessmentType: 'written-exam', tier: 'hl', externallyAssessed: true },
  ...
  },
  {
    ...
    qualificationSlug: 'ib-dp',
    subjectSlug: 'computer-science',
    code: 'DP Computer Science (2014)',
    specStatus: 'legacy-teach-out',
    relatedCode: 'DP Computer Science (2027)',
    tiers: ['sl', 'hl'],
    firstAssessment: '2014',
    // IB course page (ibo.org, read 2026-09-21): 'for the last assessment in 2026'.
    finalAssessment: '2026',
    components: [
      { paperCode: 'Paper 1', title: 'Paper 1 -- Section A: Compulsory Short-Answer Questions, Section B: Compulsory Structured Questions on the Core', durationMinutes: 90, marks: 70, weightingPercent: 45, assessmentType: 'written-exam', tier: 'sl', externallyAssessed: true },
      { paperCode: 'Paper 2', title: 'Paper 2 -- Questions on One Option (Databases, Modelling and Simulation, Web Science, or Object-Oriented Programming)', durationMinutes: 60, marks: 45, weightingPercent: 25, assessmentType: 'written-exam', tier: 'sl', externallyAssessed: true },
      { paperCode: 'Internal Assessment', title: 'Internal Assessment -- Solution (Development of a Computational Product and Supporting Documentation)', durationMinutes: null, marks: 34, weightingPercent: 30, assessmentType: 'coursework', tier: 'sl', internallyAssessed: true, externallyModerated: true },
      { paperCode: 'Paper 1', title: 'Paper 1 -- Section A: Compulsory Short-Answer Questions, Section B: Compulsory Structured Questions on the Core and HL Extension', durationMinutes: 130, marks: 100, weightingPercent: 40, assessmentType: 'written-exam', tier: 'hl', externallyAssessed: true },
      { paperCode: 'Paper 2', title: 'Paper 2 -- Questions on One Option (Databases, Modelling and Simulation, Web Science, or Object-Oriented Programming)', durationMinutes: 80, marks: 65, weightingPercent: 20, assessmentType: 'written-exam', tier: 'hl', externallyAssessed: true },
      { paperCode: 'Paper 3', title: 'Paper 3 -- Compulsory Questions on a Pre-Seen, Annually Issued Case Study (HL Only)', durationMinutes: 60, marks: 30, weightingPercent: 20, assessmentType: 'written-exam', tier: 'hl', externallyAssessed: true },
      { paperCode: 'Internal Assessment', title: 'Internal Assessment -- Solution (Development of a Computational Product and Supporting Documentation)', durationMinutes: null, marks: 34, weightingPercent: 20, assessmentType: 'coursework', tier: 'hl', internallyAssessed: true, externallyModerated: true },
    ],
    officialSourceUrl: 'https://www.ibo.org/globalassets/new-structure/programmes/dp/pdfs/computer-science---higher-level.pdf',
    verifiedOn: '2026-09-08',
    notes: 'Both tiers modeled in full, for the computer science course first assessed in 2014. Recorded as being taught out from 2026-09-17 under the site\'s rule that a specification is current once its first teaching has begun: the IB computer science updates page says the new course \'will be launched in February 2025 for first teaching in August 2025\' with \'First assessment ... in May 2027\', so a learner starting now follows that course, while this one is examined for learners partway through it (the IB\'s own DP computer science page summarizes this course "for last assessment in 2026", read on 2026-09-21, so 2026 is recorded as its last examination year). The newer course (first assessment 2027) does not yet have its own assessment record here -- a genuine, explicitly scoped gap (its official curriculum-updates page and subject brief give the papers, durations and weightings (SL Paper 1 and Paper 2 each 1 hour 15 minutes at 35%; HL each 2 hours at 40%; the computational solution 20-30%) but neither publishes mark totals, re-checked 2026-09-17, since it has not yet been examined and no specimen papers with mark totals were found). Weighting and duration figures are read directly from the IB\'s own official public subject briefs for Higher Level and Standard Level (both titled "First assessments 2014", read on 2026-09-08). Mark totals -- not published in either subject brief -- were independently confirmed against real, genuine IB markschemes read on 2026-09-08: HL Paper 1 (M23/4/COMSC/HP1) totals 100 marks (Section A 25 + Section B 75); HL Paper 2 (M19/4/COMSC/HP2) totals 65 marks ("Candidates are required to answer all questions in one Option. Total 65 marks", stated verbatim in the markscheme); HL Paper 3 (M19/4/COMSC/HP3) totals 30 marks (Q1 4 + Q2 8 + Q3 6 + Q4 12, explicitly stated as "Total: [30]"); SL Paper 1 (M19/4/COMSC/SP1) totals 70 marks (Section A 25 + Section B 45); SL Paper 2 (M19/4/COMSC/SP2) totals 45 marks ("Total 45 marks", stated verbatim). The Internal Assessment (a computational solution to a self-identified problem for a real client, word-limited written commentary plus product) is marked against five criteria -- Planning (6), Solution Overview (6), Development (12), Functionality and Extensibility (4), Evaluation (6) -- 34 marks total, identical at both tiers; this breakdown was read in the IB\'s own Computer science guide (first examinations 2014) at ibo.org on 2026-09-21, which heads the criteria "Criterion A: Planning (6 marks)", "Criterion B: Solution overview (6 marks)", "Criterion C: Development (12 marks)", "Criterion D: Functionality and extensibility of product (4 marks)" and "Criterion E: Evaluation (6 marks)" (printed pp.83-84).',
    internalNotes: 'This subject had ZERO assessment records prior to this session (syllabuses.ts already carried a record for the new/future 2027 course only, added in an earlier "Audit I07 fix", but no assessment record existed for either syllabus). Research this session confirmed a genuine two-syllabus transition is underway, the same pattern already established for ESS/Global Politics/Psychology in this dataset: the 2014 syllabus (modeled here) remains what current DP cohorts are examined under; the 2027 syllabus has started teaching (August 2025) but has not yet reached its first assessment (May 2027) and is not modeled here beyond its existing syllabuses.ts entry -- adding its assessment record is a further, separately scoped task, not attempted this round. All mark totals above were read directly from genuine IB markscheme PDFs (identifiable by their exam-code headers, e.g. M23/4/COMSC/HP1/ENG/TZ1/XX/M, and IB copyright notices), not from third-party estimates or search-engine summaries alone. sourceConfidence/mirrorSourceUrl intentionally omitted: every mark total was verified against a primary IB markscheme document itself.',
    assessmentModel: 'component-based',
  },
] as const;
