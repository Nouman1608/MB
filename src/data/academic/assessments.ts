...
export const ASSESSMENTS: readonly Assessment[] = [
  ...
  },
  {
    ...
    verifiedOn: '2026-08-27',
    notes: 'Directly confirmed against the official PDF (Assessment overview, p.9): Paper 1 Multiple Choice (45min, 30 marks, 30%, all 30 questions compulsory) and Paper 2 Structured Questions (2h15, 90 marks, 70%, one compulsory question plus three from a choice of four), both externally assessed. Not tiered; grades A*-E. This record models the single-year 2026 syllabus edition, so firstAssessment and finalAssessment are both 2026; Cambridge has also published a 2027-2029 edition of 2281 (718206), which is not modeled here.',
    assessmentModel: 'linear',
  },
  {
    boardSlug: 'cambridge',
  ...
  },
  {
    ...
    verifiedOn: '2026-08-28',
    notes: 'Directly confirmed against the official AQA specification PDF (\'AS and A-level Business AS (7137) A-level (7138) Specification\', Version 1.1, November 2025): linear, not tiered, two compulsory written papers, each 1h45/80marks/50% of AS. Paper 1 (Unit 3.1: What is business? Managing marketing and finance): two case studies, each followed by six compulsory questions worth 40 marks in total. Paper 2 (Unit 3.2: Managing people and operations, with links to Unit 3.1): same two-case-study format. Total 160 marks (raw marks scaled ×1). Replaces 7131: for teaching from September 2026 onwards, first AS exams June 2027. 7131 was last examined in summer 2026. 7137 has been taught from September 2026 and is recorded here as the current specification, with relatedCode 7131.',
    assessmentModel: 'linear',
  },
  {
    boardSlug: 'ocr',
  ...
  },
  {
    ...
    marksSourceNote: 'The IB\'s public subject brief for this course gives durations and weightings but no marks. The Paper 1 and Paper 3 totals shown were read from copies of May 2019 IB markschemes found on third-party websites; the Paper 2 total was carried over from an earlier check whose source the record does not name; and the internal assessment\'s 22 marks came from third-party teacher resources. None was read from a document published by the IB.',
