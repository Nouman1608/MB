...
export const SYLLABUSES: readonly Syllabus[] = [
  ...
  },
  {
    ...
    verifiedOn: '2026-08-18',
    notes: 'The summary is a Marlbridge-written factual description, not a verbatim quote — the syllabus overview page could not be fetched directly on 2026-08-18 (redirect-only response); code, series and content verified independently against the official syllabus PDF.',
  },
  {
  ...
  },
  {
    ...
    verifiedOn: '2026-08-21',
    notes: 'UK domestic GCE A-level, for teaching from September 2017, A-level exams 2019 onwards.',
  },
  {
