...
export const SUBJECTS: readonly CanonicalSubject[] = [
  ...
  { slug: 'myp-sciences', name: 'Sciences (MYP)', aliases: ['Integrated Sciences'], source: 'ibo.org MYP subject brief, myp-brief-sciences-en.pdf', notes: 'MYP Sciences is one subject group whose courses usually include biology, chemistry and physics, taught by schools as separate, modular or integrated courses (not only as an integrated subject), so this is kept distinct from those DP/Cambridge-style canonical subjects rather than reusing one of them.' },
