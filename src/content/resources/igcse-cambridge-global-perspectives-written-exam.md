---
title: "Cambridge IGCSE Global Perspectives: The Written Exam (0457)"
...
**CAMBRIDGE IGCSE GLOBAL PERSPECTIVES (0457) — COMPONENT 1 WRITTEN
EXAM**

Component 1 is a 1 hour 25 minute written paper worth 70 marks,
externally set and marked by Cambridge International. It contains four
compulsory questions based on source documents provided with the
question paper, covering a global issue related to one of the topics
on the topic list. Sources provide background information and
different perspectives on the chosen issue and may include images and
material from a variety of subject backgrounds and media.

## How to approach it

Because Component 1 is entirely source-based rather than testing
memorised content, practising close, careful reading of unfamiliar
source material under timed conditions is the single most useful
preparation -- work through past papers focused on extracting
perspectives and evidence from sources you have never seen before,
not on revising facts about specific topics. Since the exam explicitly
tests skills like identifying different perspectives and evaluating
evidence, practise naming whose perspective a source represents and
what evidence supports it, rather than simply summarising what a
source says. Reading time is built into the paper's overall time
allowance, so practise budgeting time to read all sources thoroughly
