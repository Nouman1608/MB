---
title: "AS Chemistry: Aldehydes and Ketones — Practice Questions"
...
Related: [Aldehydes and Ketones revision notes](/resources/as-chem-carbonyls-revision-notes/)
...
**(c)** Explain what this tells us about the intermediate. **[2]**
...
**(b)** Equal amounts of both **enantiomers** are formed — a **racemic mixture** [1] [1]; their **equal and opposite optical rotations cancel** [1].
**(c)** The carbonyl carbon is **planar** [1], so the nucleophile attacks with **equal probability from either face** [1].
...
*Both work because aldehydes are readily oxidised to carboxylic acids and ketones are not.*
