---
title: "IGCSE Mathematics: Geometry — Practice Questions"
...
**(a)** State the circle theorem that lets you find angle R. **[1]**
...
**4. (a)** Scale factor = 5 ÷ 2 = **2.5** [1].
**(b)** Area scale factor = 2.5² = 6.25 [1]. Area of PQR = 12 × 6.25 = **75 cm²** [1].
...
**7. (a)** The **angle at the centre is twice the angle at the circumference**, standing on the same arc [1].
**(b)** 2 × 35° = **70°** [1].

**8. (a)** **Opposite angles of a cyclic quadrilateral sum to 180°** [1].
**(b)** 180° − 108° = **72°** [1].
