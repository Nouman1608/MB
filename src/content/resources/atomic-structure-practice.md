...
**(b)** State which group and which period this places magnesium in, explaining how you know. **[2]**
...
**5. (a)** **2,8,2** [1].
**(b)** **Group II**, because the outer shell has 2 electrons [1]; **Period 3**, because 3 shells are occupied [1].
