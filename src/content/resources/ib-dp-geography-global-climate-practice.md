---
title: "IB DP Geography Core: Global Climate -- Vulnerability and Resilience -- Practice Questions"
...
Related: [Global Climate revision notes](/resources/ib-dp-geography-global-climate-revision-notes/)
and the [IB DP Geography syllabus guide](/resources/ib-dp-geography-syllabus-guide/).
...
**4.** Two coastal towns face an identical rise in flood risk from sea-level rise. Town A has weak building codes and low household incomes; Town B has strong building codes and higher household incomes.
...
**6.** Using a named, specific case study you have studied, examine how a place's exposure, sensitivity and adaptive capacity together shaped its vulnerability to a climate hazard. **[8]**

**7.** Discuss the extent to which mitigation, rather than adaptation, should be prioritised in responding to climate change in vulnerable regions. **[8]**
...
**7.** A strong discussion recognises that mitigation and adaptation address different problems: mitigation reduces the underlying causes and long-term scale of climate change, while adaptation manages the effects that are already occurring or unavoidable given past emissions. For already-vulnerable regions facing near-term hazards, adaptation often delivers more immediate protection (e.g. flood defences protecting a community this decade), while mitigation's benefits are typically longer-term, global in scope, and depend on collective action beyond any one vulnerable region's control -- meaning a vulnerable region investing heavily in mitigation alone while facing an imminent hazard could be poorly served in the short term. Conversely, over-relying on adaptation without any mitigation risks an ever-escalating and eventually unmanageable scale of hazard. A well-evaluated answer concludes that vulnerable regions typically need both, but that the balance depends on a region's specific exposure timeline, resources and the hazards it already faces, rather than one approach being universally preferable. **[8]**

## Why this set stays case-study anchored

Questions 6 and 7 are deliberately written at extended-response length and structure, since Paper 2's
core-theme questions on Global climate routinely require named, specific case-study evidence rather
than generic description -- exactly the distinction the revision notes flag as separating strong from
weak answers on this compulsory core theme. Question 5's evaluate-style format also tests the kind of
concept-precision (resilience vs vulnerability) that a purely descriptive revision pass can miss.

## Official syllabus

International Baccalaureate Organization, *Diploma Programme Subject Brief -- Individuals and
Societies: Geography*, first assessment 2019 -- the same source cited by the
[Global Climate revision notes](/resources/ib-dp-geography-global-climate-revision-notes/) and the
[IB DP Geography syllabus guide](/resources/ib-dp-geography-syllabus-guide/).
