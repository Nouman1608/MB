---
title: "AS Chemistry: Group 2 — Practice Questions"
...
Related: [Group 2 revision notes](/resources/as-chem-group2-revision-notes/)
...
**(b)** State and explain the trend in thermal stability down the group. **[4]**
...
**4.** Solubility **decreases** down the group [1] — MgSO₄ is soluble whereas BaSO₄ is insoluble [1].
*The two trends run in opposite directions, and mixing them up is the standard error.*
...
**7.** Any two, each with a reason:
**Calcium hydroxide** on fields [1] to **neutralise acidic soil** [1].
**Magnesium hydroxide** in indigestion remedies [1] to **neutralise excess stomach acid** [1].
*(Also: barium sulfate as a medical "barium meal" — it is insoluble so it is not absorbed and is non-toxic.)*
...
For condensed recall notes on this topic, see the [Group 2 revision notes](/resources/as-chem-group2-revision-notes/); for the full explanation with worked examples, see the [Group 2: The Alkaline Earth Metals study guide](/resources/as-group-2-the-alkaline-earth-metals/).
