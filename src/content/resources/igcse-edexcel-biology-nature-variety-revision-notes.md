---
title: "Edexcel IGCSE Biology: Nature and Variety of Living Organisms — Revision Notes"
...
[Nature and Variety of Living Organisms study guide](/resources/igcse-edexcel-biology-nature-and-variety-of-living-organisms/).
...
|---|---|---|
| **Plants** | Multicellular, **chloroplasts**, cellulose wall, store starch and sucrose | Flowering plants, ferns |
| **Animals** | Multicellular, no wall, no chloroplasts, store **glycogen**, usually nervous coordination | Mammals, insects |
| **Fungi** | Body of **hyphae** forming a mycelium, **chitin** wall, **saprotrophic** nutrition, store glycogen | Mucor, yeast (single-celled) |
...
Not a kingdom, but a category — organisms that cause disease.

| Pathogen | Nature | Example |
|---|---|---|
| **Virus** | **Not living** — no cytoplasm, no nucleus; protein coat around DNA or RNA | Influenza, HIV, tobacco mosaic virus |
| **Bacterium** | Prokaryote | *Pneumococcus* |
| **Protoctist** | Single-celled eukaryote | *Plasmodium* (malaria) |
| **Fungus** | Hyphae | *Candida* |
...
- Defining growth without "permanent" or "dry mass".
- Saying fungi photosynthesise — they have no chloroplasts.
- Giving cellulose as the fungal cell wall material; it is chitin.
- Describing saprotrophic nutrition as absorption then digestion — it is the reverse.
- Saying viruses are living, or saying they are not living without giving a reason.
- Attributing glycogen storage to plants.

## Self-test

1. Distinguish excretion from egestion.
2. Give three features of the fungal kingdom.
