...
**(b)** There are **legal formalities and costs** — accounts must be filed publicly and audited, which is expensive and time-consuming [1] [1]. **Ownership is diluted**, so the original owner **may lose some control** over decisions if shares are sold widely [1] [1].
...
Organic advantage: it is **slower and easier to manage**, so the culture and quality are maintained [1]. Organic disadvantage: it is **slow**, so rivals may capture the market first [1].
