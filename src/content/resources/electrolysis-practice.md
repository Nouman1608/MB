...
**(a)** State what should be used as the anode, the cathode and the electrolyte. **[3]**
**(b)** Give **two** reasons for electroplating. **[2]**
...
**5. (a)** Anode: **pure silver** [1]. Cathode: **the spoon** [1]. Electrolyte: a **solution of a silver salt**, e.g. silver nitrate [1].
