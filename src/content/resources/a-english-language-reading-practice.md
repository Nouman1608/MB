---
title: "A Level English Language: Reading and Analysis — Practice Questions"
...
**1. Lexis** — the **vocabulary of a text: which words are chosen** [1]. **Semantics** — the **meanings words carry** and how meaning is constructed [1]. **Grammar** — the **structure of words and sentences**, including morphology and syntax [1]. **Phonology** — the **sound patterns**, such as alliteration, assonance and rhythm [1]. **Pragmatics** — how **meaning depends on context and on what is implied rather than stated** [1].

**2. Register** is the **variety of language appropriate to a particular situation** [1]. It is determined by **field** — the subject matter [1]; **tenor** — the relationship between the participants [1]; and **mode** — whether the text is spoken, written or somewhere between [1].

**3. (a)** "Child" carries **connotations of innocence and dependence**, making the reader feel a protective obligation [1]. "Loses" frames blindness as **something taken away rather than absent from birth**, which is more affecting [1]. "Cure" is **absolute and certain**, promising a definite outcome rather than a vague improvement [1]. "The price of a coffee" uses **deliberately mundane, everyday lexis**, shrinking the perceived cost and implying that not giving is a trivial choice the reader is actively making [1].
...
- Naming a technique without analysing its effect on meaning.
- Confusing semantics with pragmatics.
- Describing formality through vocabulary alone, ignoring grammar.
- Treating connotation as personal opinion rather than shared association.
