...
level: ["ib"]
topic: "Exam preparation -- Papers 1, 2, HL Paper 3 and the historical investigation"
boards: ["ib"]
...
HL students sit an entirely additional paper built around a regional depth study not examined at SL
at all -- new content layered on top of the shared SL core, not merely a longer or harder version of
Papers 1-2. **Exam-preparation priority**: treat Paper 3's regional study as requiring genuinely
separate revision time proportionate to its 35% weighting, with its own bank of dated evidence,
rather than assuming strong Paper 1/2 preparation will transfer automatically.

## The four concepts as transferable analytical tools

Cause and consequence, continuity and change, perspectives, and significance run through all three
papers and the historical investigation. **Exam-preparation priority**: revise the four concepts as
transferable analytical tools that can be applied to any period or source, rather than as abstract
theory defined once and then forgotten -- for example, practise using "perspectives" to explain why
two sources on the same event might disagree, given their different origins, across more than one
topic.
...
1. What distinguishes Paper 1 from Paper 2 and Paper 3 in terms of the skill it tests?
2. Why must a strong Paper 2 or Paper 3 essay use specific, dated evidence rather than general
   narrative description?
3. In the worked scenario, why is the source valuable for one question (official messaging) but
...
version of the SL-shared content tested in Papers 1-2.
...
[assessment revision notes](/resources/ib-dp-history-assessment-revision-notes/) and
[full syllabus guide](/resources/ib-dp-history-syllabus-guide/). The worked scenario above is an
