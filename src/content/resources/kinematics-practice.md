...
syllabusTopics:
  ...
  - qualification: "o-level"
    topic: "motion-forces-and-energy"
    subtopic: "motion"
description: "Original exam-style practice questions with full worked answers on speed, acceleration, motion graphs and the area under a speed-time graph."
...
**(b)** Time up = 15 ÷ 9.8 = 1.53 s [1]; total time = **3.1 s** [1].
**(c)** **9.8 m/s² downwards** [1]; gravity still acts on the stone even though its velocity is momentarily zero [1].
