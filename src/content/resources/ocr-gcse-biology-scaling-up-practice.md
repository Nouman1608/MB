---
title: "OCR GCSE Biology: Scaling Up — Practice Questions"
...
description: "Original exam-style practice questions with full worked answers on diffusion, osmosis, active transport, surface area to volume ratio, and the human and plant transport systems for OCR GCSE (9-1) Biology A Gateway Science (J247), Topic B2 Scaling Up."
...
**1.** Which of these processes moves substances against a concentration gradient and requires energy from respiration?
A) Diffusion of oxygen into a cell
B) Osmosis of water into a cell
C) Active transport of mineral ions into a root hair cell
D) Diffusion of carbon dioxide out of a leaf **[1]**

**2.** A cube-shaped organism has sides of length 2 mm. What is its surface area to volume ratio?
A) 1:3
B) 2:1
C) 3:1
D) 6:1 **[1]**

**3.** Which row correctly describes xylem tissue?
A) Living cells; transports sugars; movement in both directions
B) Dead cells; transports water and mineral ions; movement upward only
C) Dead cells; transports sugars; movement downward only
D) Living cells; transports water; movement in both directions **[1]**

**4.** Which of the following is the correct definition of osmosis?
A) The net movement of water molecules from a region of higher water concentration to a region of lower water concentration, through a partially permeable membrane
B) The net movement of solute particles from a region of high to low concentration
C) The movement of any substance from a low to a high concentration, using energy
D) The diffusion of gases across a respiratory surface **[1]**

**5.** Why does the exchange of substances between blood and tissues occur mainly at capillaries rather than at arteries?
A) Capillaries carry blood at very high pressure
B) Capillary walls are one cell thick, and blood flows slowly through the very large total cross-sectional area they provide, giving time for diffusion
...
**1. C)** Active transport moves substances against a concentration gradient and requires energy from respiration; diffusion and osmosis are both passive processes that need no energy [1].

**2. C)** Surface area = 6 × (2 × 2) = 24 mm². Volume = 2 × 2 × 2 = 8 mm³. Ratio = 24:8 = 3:1 [1].

**3. B)** Xylem is made of dead cells and transports water and dissolved mineral ions in one direction only, upward from the roots; phloem, not xylem, transports sugars in both directions using living cells [1].

**4. A)** Osmosis is specifically the net movement of water (not solutes) down a water concentration gradient, through a partially permeable membrane; option B describes diffusion of a solute, and option C wrongly adds an energy requirement [1].
