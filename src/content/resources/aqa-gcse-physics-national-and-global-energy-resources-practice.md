---
title: "AQA GCSE Physics: National and Global Energy Resources — Practice Questions"
...
**(a)** State whether natural gas is a renewable or non-renewable resource. **[1]**
**(b)** Give one environmental issue associated with burning natural gas. **[1]**
**(c)** Give one economic or social issue that might be considered when deciding whether to build a new gas power station. **[1]**
...
**7. (a)** **Non-renewable** (a fossil fuel) [1].
**(b)** Burning natural gas releases **carbon dioxide**, contributing to climate change (accept air pollution) [1].
**(c)** Any reasonable answer, e.g. the **cost of building and running the power station**, or **local opposition/job creation** in the surrounding area [1].
