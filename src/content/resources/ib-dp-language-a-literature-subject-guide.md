---
title: "IB Diploma Programme Language A: Literature: Subject Overview"
...
IB Diploma Programme Language A: Literature explores the various
manifestations of literature as a powerful mode of writing across
cultures and throughout history. The course develops an understanding
of the factors that contribute to the production and reception of
literature -- the creativity of writers and readers, the nature of
...
- engage with a range of texts, in a variety of media and forms, from
  different periods, styles and cultures
- develop skills in listening, speaking, reading, writing, viewing,
...
- develop an understanding of relationships between texts and a
  variety of perspectives, cultural contexts, and local and global
  issues
...
specification's central idea that reading is an active process:
readers construct meaning from a writer's choices rather than simply
receiving a single fixed meaning. Because this course studies literary
works exclusively, this component goes deeper into technique than the
equivalent component in Language A: Language and Literature, which
must divide its attention between literary and non-literary texts. A
strong answer within this component does not merely name a technique
-- it explains what interpretive possibilities that specific choice
opens up or closes off for the reader, and this skill of moving from
technique to effect transfers directly into Paper 1's guided analysis
of an unseen literary extract.
...
its conventions and assumptions, and revising this component means
practising the identification of a specific, genuine point of
connection -- a shared theme, a shared form, or a direct reference --
rather than describing two works side by side without relating them.
...
Comparing SL and HL side by side clarifies where the real assessment
differences lie: Paper 1 is weighted identically at both levels, so
the guided literary analysis skill matters equally regardless of
level, while Paper 2's comparative essay is weighted more heavily at
SL (35%) than at HL (25%), where the balance shifts instead toward the
independently produced HL essay. Students should read this as a signal
about where preparation time is best spent at each level, not simply
as an administrative detail.

## Source

International Baccalaureate Organization, Language A: Literature
subject brief (Diploma Programme), 2019.
