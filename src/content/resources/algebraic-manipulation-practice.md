...
Related: [Algebraic Manipulation revision notes](/resources/algebraic-manipulation-revision-notes/)
...
**1. (a)** 6x − 15 + 4x + 8 [1] = **10x − 7** [1].
**(b)** x² − 3x + 6x − 18 [1] = **x² + 3x − 18** [1].
...
**(b)** T/(2π) = √(x/g) [1]; T²/(4π²) = x/g [1]; **x = gT²/(4π²)** [1].
