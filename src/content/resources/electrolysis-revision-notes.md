---
title: "Electrolysis and Fuel Cells: Revision Notes"
...
syllabusTopics:
  ...
  - qualification: "o-level"
    topic: "electrochemistry"
    subtopic: "hydrogen-oxygen-fuel-cells"
description: "Condensed recall notes on electrolysis of molten and aqueous compounds, predicting products, electroplating and fuel cells for Cambridge IGCSE 0620 and O Level 5070."
author: "nouman-ahmed"
...
[Electrolysis and Fuel Cells study guide](/resources/electrolysis-and-fuel-cells/).
...
**At the cathode:** the **less reactive** of the metal and hydrogen is discharged.
→ Metal **below** hydrogen in the reactivity series (Cu, Ag) → metal deposited.
→ Metal **above** hydrogen (Na, K, Ca, Mg, Al, Zn, Fe) → **hydrogen gas**.
...
and oxygen forms at the anode, as the table above shows. But with
**copper electrodes**, copper still deposits at the cathode — the
copper anode **dissolves instead** of oxygen being released. This is
the basis of both electroplating (below) and purifying copper.
...
1. Name the products of electrolysing molten aluminium oxide.
2. Concentrated potassium chloride solution — give the product at each electrode.
3. Write the cathode half equation for copper(II) sulfate solution.
4. Which electrode is the object during electroplating?
5. Give one advantage and one disadvantage of a hydrogen fuel cell.
6. How does electrolysing copper sulfate with copper electrodes differ from using inert electrodes?
7. Give one difference between a hydrogen fuel cell and a petrol engine, other than the product formed.
...
For the full worked explanation with additional detail, see the [Electrolysis and Fuel Cells study guide](/resources/electrolysis-and-fuel-cells/); for exam-style questions with full mark schemes, see the [Electrolysis practice questions](/resources/electrolysis-practice/).
