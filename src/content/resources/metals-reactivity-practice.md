...
**4. (a)** Fe₂O₃ + 3CO → 2Fe + 3CO₂ [1], correctly balanced [1].
**(b)** The limestone **decomposes to calcium oxide and carbon dioxide** in the heat [1]; the calcium oxide is **basic and reacts with the acidic silicon dioxide impurity** [1] to form **calcium silicate — molten slag**, which floats on the iron and is drained off [1].
