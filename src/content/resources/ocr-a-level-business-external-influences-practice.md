---
title: "OCR A Level Business: External Influences Facing Businesses — Practice Questions"
...
Related: [External Influences Facing Businesses study guide](/resources/ocr-a-level-business-external-influences/) | [External Influences Facing Businesses revision notes](/resources/ocr-a-level-business-external-influences-revision-notes/)
...
**6.** State **one** advantage and **one** disadvantage of the UK **not** being part of the EU/Eurozone and the single market for a UK business, explaining each in the context of a specific business rather than in the abstract. **[6]**
...
**3.** Market structure is best understood through decision-making power and barriers to entry/exit rather than fixed labels. **Monopolistic competition** has many firms [1] and low pricing power because differentiated products still compete closely on price [1]. **Oligopoly** has few large, interdependent firms with moderate-to-high pricing power, since each must react to rivals' pricing decisions [1] [1]. **Monopoly** has one dominant firm with high pricing power because barriers to entry are severe [1]. A real firm sits somewhere on this spectrum, and a strong evaluative answer identifies *where* rather than forcing it into one textbook box [1].
...
**5.** **Market dominance** is about decision-making power over price and output relative to competitors, not size alone [1] [1]. A **large firm operating in a market with low barriers to entry or exit** — where several credible rivals can enter easily, or products are easily substitutable — may have little real pricing power despite its size, because customers and potential entrants constrain its choices [1] [1].

**6.** *Example advantage:* being outside the EU and single market means a UK business is **free from EU regulatory standards** it might otherwise have to meet, and the UK government can negotiate **independent trade deals** with non-EU countries that may suit a specific business's export markets better than an EU-negotiated deal would [1] [1] [1]. *Example disadvantage:* a UK exporter now faces **customs checks, rules-of-origin paperwork and potential tariffs** when selling into the EU that did not apply when the UK was a member, raising costs and slowing delivery times, and the business no longer has **automatic tariff-free access** to the single market it previously had [1] [1] [1].
