---
title: "Edexcel IGCSE Physics: Astrophysics — Revision Notes"
...
[Astrophysics study guide](/resources/edexcel-igcse-physics-astrophysics/).

## The solar system

The Sun, eight planets, dwarf planets, moons, asteroids and comets.

**Orbits are elliptical**, though planetary orbits are nearly circular. **Comets have highly elliptical orbits**, so their speed varies greatly: they move **fastest at their closest approach to the Sun** and slowest when furthest away.

**The reason is energy conservation** — as a comet approaches, gravitational potential energy is converted into kinetic energy, so it speeds up. Stating that mechanism rather than just the fact is what earns the mark.
...
**Fusion** joins hydrogen nuclei into helium, releasing energy. Elements heavier than iron are formed in **supernovae**, which is why the atoms in everything around us came from earlier generations of stars.

## Redshift and the Big Bang

**Redshift** — light from distant galaxies is shifted towards longer wavelengths, showing the source is **moving away**.

**Two observations together give the conclusion:**

1. Almost all galaxies are redshifted → they are receding.
2. **More distant galaxies show greater redshift** → they are receding faster.
...
- Saying orbits are circular.
- Stating that comets speed up near the Sun without explaining the energy conversion.
- Confusing the two stellar life cycles, or omitting mass as the deciding factor.
- Explaining main-sequence stability without naming both opposing forces.
- Claiming redshift shows Earth is at the centre.
- Giving CMBR as evidence without saying what it shows.

## Self-test

1. Why does a comet travel fastest near the Sun?
2. What provides the centripetal force for an orbit?
