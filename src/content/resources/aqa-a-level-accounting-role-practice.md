...
Related: [The Role of the Accountant revision notes](/resources/aqa-a-level-accounting-role-revision-notes/)
...
**3. Materiality** — an item is material if **omitting or misstating it would influence a user's decision** [1]; immaterial items may be treated in the simplest way, e.g. writing off a cheap stapler rather than depreciating it [1].
