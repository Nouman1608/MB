---
title: "A Level Economics: Markets in Action — Practice Questions"
...
Related: [Markets in Action revision notes](/resources/a-economics-markets-in-action-revision-notes/)

This paper follows the specification's four-section structure for a Unit 1/2-style paper: Section A is six multiple-choice questions (6 marks), Section B is five short-answer questions (20 marks), Section C is a five-part question built around a single scenario (34 marks), and Section D is one essay answered from a choice of two (20 marks). Command words and their mark tariffs follow the specification's command word table: define (2), calculate (2 or 4), draw (4), explain (4), analyse (6), examine (8), discuss (14), and evaluate / to what extent (20).

---

## Section A — Multiple choice

**1.** Which of the following would cause a **shift** of the demand curve for a good, rather than a movement along it?
A) A fall in the good's own price
B) A rise in consumer income
C) The change in quantity demanded that follows a price change
D) A movement to a different point on the same curve **[1]**

**2.** A good has an income elasticity of demand of −0.6. This good is:
...
D) Non-excludable and non-rival **[1]**

**4.** Adverse selection in an insurance market arises because:
A) Insured individuals become more careless after buying cover
B) The insurer has more information than the buyer
C) Higher-risk individuals are more likely to buy insurance than lower-risk individuals
D) The government sets the premium too low **[1]**

**5.** A minimum wage is most likely to raise employment in a labour market where:
A) The employer is a wage taker in a competitive labour market
B) The employer is a monopsonist and the minimum wage is set between the monopsony wage and the competitive wage
C) Labour supply is perfectly inelastic
D) The minimum wage is set below the current market wage **[1]**

**6.** Government failure occurs when:
A) A market fails to reach equilibrium
B) Government intervention leads to a less efficient allocation of resources than before the intervention
C) A firm exploits monopoly power
D) A tax fails to raise any revenue **[1]**
...
**10.** Explain why a public good will not be provided by a free market. **[4]**

**11.** Analyse how a tradable permit scheme corrects a negative externality differently from a fixed indirect tax. **[6]**
...
**(d)** Explain why this tax may raise substantial government revenue but achieve only a small reduction in the quantity of sugary drinks consumed. **[4]**

**(e)** Evaluate the extent to which this indirect tax is likely to be an effective policy for reducing the negative externality associated with sugar consumption. **[20]**

---

## Section D — Essay (answer ONE)
...
**1. B)** A rise in consumer income is a change in a condition of demand other than the good's own price, so it shifts the whole curve; the other options describe movements along the curve or restate what a movement along the curve is [1].

**2. C)** A negative income elasticity of demand means quantity demanded falls as income rises, which is the definition of an inferior good [1].

**3. D)** A public good is non-excludable (non-payers cannot be prevented from consuming it) and non-rival (one person's consumption does not reduce what is available to others) [1].

**4. C)** Adverse selection arises because the buyer knows more about their own risk than the insurer, so higher-risk individuals are more likely to seek insurance, pushing up the average risk (and cost) of the insured pool [1].

**5. B)** A monopsonist restricts employment below the competitive level to keep wages down; a minimum wage set between the monopsony wage and the competitive wage removes the incentive to restrict employment, so both wages and employment can rise [1].

**6. B)** Government failure is where intervention leaves resource allocation less efficient than before, for example through information gaps, administrative costs, unintended consequences, or regulatory capture [1].
...
**10.** A public good is **non-excludable** — a supplier cannot stop a non-payer from consuming it [1] — and **non-rival** — one person's consumption does not reduce what is available to others [1]. Because non-payers cannot be excluded, a **free-rider problem** arises: no one has an incentive to pay [1], so a private firm cannot generate enough revenue to profitably supply the good, and the market provides **none at all** [1].

**11.** A **tradable permit scheme** sets a **cap on total output or emissions** [1] and allows firms to buy and sell permits within that cap [1], so the **market finds the cheapest way to reduce the externality** across firms with different abatement costs [1]. A **fixed indirect tax** instead sets a **price** on the externality [1], but leaves the resulting **quantity** of the externality uncertain [1], whereas a permit scheme fixes the quantity and lets the **price** of a permit adjust in the market [1].
...
- Using a production-externality diagram (MSC above MPC) for a scenario where the externality is on the **consumption** side (MSB/MPB) or vice versa.
- Unlabelled externality diagrams — an unlabelled diagram earns no diagram marks.
- Confusing adverse selection with moral hazard.
- Claiming a tax on a good with inelastic demand will substantially cut consumption, rather than recognising that it raises revenue precisely because consumption barely changes.
- Omitting government failure from an evaluation of intervention.
- A conclusion with no criterion — "it depends on the size of the externality" is a conclusion; "there are pros and cons" is not.
- Giving only one property of a public good.
- Confusing what a tax fixes (price, leaving quantity uncertain) with what a tradable permit scheme fixes (quantity, leaving price to the market).
- Using a command word (e.g. "describe", "state", "distinguish") that is not one of this specification's eight command words, or setting a tariff that does not match the mark allocation the specification gives for the command word used.
