---
title: "Unit 2 Drama (YET01): Practice Questions"
...
Both sections of Unit 2 give a genuine choice of question, and both are marked against the
same four objectives (AO1, AO2, AO3, AO5). The two Section A questions and two Section B
questions below model the range of ways the exam can phrase its demand, so that practising
...
- Section A answers that treat context as separate background information rather than integrating it into the analysis of a specific dramatic moment.
- Discussing a character only through dialogue, ignoring staging, stage directions and performance choices central to how drama makes meaning.
- Naming AO5 in an introduction but then arguing only one fixed reading throughout the rest of the essay, leaving the objective effectively unaddressed.
- On Q1b and Q3-style "how far" questions, asserting a conclusion without a sustained argument that actually tests the claim against textual evidence.
- Under-using the open-book allowance — vague or paraphrased "quotations" when the actual clean, unannotated text is available to check during the exam.
- Choosing a question in the exam without first checking it fits the specific staging, character or contextual knowledge you know best for your set text — the alternative-question structure exists precisely so you can play to your strengths.

## Choosing between the question styles in each section

The two questions offered within each section reward slightly different preparation, even though both are marked against the same four objectives. A question centred on a character or theme (like Q1 or Q2) rewards having a clear map of the key moments where that character or theme develops across the play, ready to discuss regardless of the exact wording. A question centred on convention or context (like Q1b or Q3) rewards having specific points of comparison prepared in advance — the genre or period the play draws on, and at least one documented critical or directorial reading that differs from your own, so that AO5 can be deployed precisely rather than reconstructed under time pressure. Practising both styles against your own set texts, rather than assuming the exam will favour one type of question, is the safest preparation given the open choice within each section.
