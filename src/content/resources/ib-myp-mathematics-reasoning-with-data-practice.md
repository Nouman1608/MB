---
title: "IB MYP Mathematics: Reasoning with Data -- Practice Questions"
...
> reasoning MYP Mathematics's assessment criteria actually reward. They are
...
Related: [Reasoning with Data study guide](/resources/ib-myp-mathematics-reasoning-with-data/) and
...
**(a)** Explain why the mean is a misleading measure of central tendency for this data set. **[2]**
**(b)** State which measure would better represent this data set, and why. **[2]**
...
**(a)** Calculate the theoretical probability. **[1]**
**(b)** Calculate the experimental probability from the trial. **[1]**
**(c)** Explain why these two values are not expected to be identical, even though the die is fair. **[2]**
...
**(a)** Identify which assessment criterion is weakest in this response, and why. **[2]**
**(b)** Describe what should be added to strengthen it. **[3]**
...
International Baccalaureate Organization, *Middle Years Programme Subject Brief -- Mathematics*, from 2020, first assessment 2022 -- the same source cited by the [study guide](/resources/ib-myp-mathematics-reasoning-with-data/) and [revision notes](/resources/ib-myp-mathematics-reasoning-with-data-revision-notes/). Verified 2026-09-06.
