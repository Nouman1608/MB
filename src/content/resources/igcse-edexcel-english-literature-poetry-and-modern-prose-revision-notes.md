---
title: "Poetry and Modern Prose (4ET1): Revision Notes"
...
description: "Condensed recall notes on the three-section structure and assessment objectives of Component 1 for Pearson Edexcel International GCSE English Literature (4ET1)."
...
[Poetry and Modern Prose study guide](/resources/igcse-edexcel-english-literature-poetry-and-modern-prose/).

## Component 1 at a glance

| Section | Focus | Marks | AOs |
|---|---|---|---|
| A | Unseen poem (printed on the paper) | 20 | AO2 |
...
- The poem is printed on the paper — no memorisation needed, just strong analytical skill.
- Pure AO2: focus entirely on **how** meaning and effects are created (language, form, structure), not what happens to be recalled about the poet.
