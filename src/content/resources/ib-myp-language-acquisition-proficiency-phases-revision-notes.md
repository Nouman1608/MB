...
```
Emergent expectation:    simple sentences, basic vocabulary,
                         formulaic expressions
Capable expectation:     a range of sentence structures, more precise
                         vocabulary, awareness of register for a
                         given audience/purpose
Proficient expectation:  complex, nuanced structures, idiomatic
                         language, sophisticated audience awareness
Consequence:             the capable student should practise varied
                         sentence structure and basic register
                         awareness -- not emergent-level formulaic
                         phrases, and not proficient-level idiom that
                         risks errors beyond their genuinely secure
                         range
```
...
Because speaking is internally assessed and externally moderated as its own interactive task, build a
genuinely separate revision routine for oral fluency — rehearsing spontaneous, interactive
conversation under time pressure, not prepared monologues — rather than assuming comprehensive written
revision automatically prepares you for it too.
...
- Remember all four criteria are equally weighted — no single skill should dominate revision time.

## Connecting to the DP pathway

MYP language acquisition examination tasks are explicitly aligned with the skills needed for high
...
MYP Language Acquisition is compulsory in every year of the programme, with one specific exception:
