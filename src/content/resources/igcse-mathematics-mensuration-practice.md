---
title: "IGCSE Mathematics: Mensuration — Practice Questions"
...
**(a)** the circumference of the circle. **[2]**
**(b)** the area of the circle. **[2]**
...
**(a)** its volume. **[2]**
**(b)** its total surface area. **[3]**

**6.** A cone has radius 3 cm and slant height 5 cm. Taking π = 3.142, calculate:

**(a)** the perpendicular height of the cone. **[2]**
**(b)** the volume of the cone. **[2]**
...
**3. (a)** C = 2πr = 2 × 3.142 × 8 = **50.3 cm** (3 s.f.) [2].
**(b)** A = πr² = 3.142 × 8² = **201 cm²** (3 s.f.) [2].

**4. (a)** Arc length = (60/360) × 2 × 3.142 × 8 = (1/6) × 50.27 [1] = **8.38 cm** (3 s.f.) [1].
**(b)** Sector area = (60/360) × 3.142 × 8² = (1/6) × 201.1 [1] = **33.5 cm²** (3 s.f.) [1].

**5. (a)** V = πr²h = 3.142 × 4² × 10 [1] = **503 cm³** (3 s.f.) [1].
**(b)** SA = 2πrh + 2πr² = (2 × 3.142 × 4 × 10) + (2 × 3.142 × 4²) [1] = 251.4 + 100.5 [1] = **352 cm²** (3 s.f.) [1].

**6. (a)** Using Pythagoras: h² = 5² − 3² = 25 − 9 = 16 [1] → h = **4 cm** [1].
**(b)** V = ⅓πr²h = ⅓ × 3.142 × 3² × 4 [1] = **37.7 cm³** (3 s.f.) [1].
