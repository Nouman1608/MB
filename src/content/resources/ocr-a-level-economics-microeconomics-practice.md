...
**(a)** Explain the factors determining the demand for labour. **[4]**
**(b)** Explain why wages differ between occupations, giving **three** reasons. **[6]**
...
**4.** A maximum price below equilibrium means **quantity demanded exceeds quantity supplied**, creating a **shortage of rental housing** [1] [1]. Tenants who obtain a tenancy **pay less**, gaining consumer surplus, but **many others cannot find housing at all** [1].
