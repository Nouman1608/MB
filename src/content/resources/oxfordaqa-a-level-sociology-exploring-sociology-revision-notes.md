---
title: "OxfordAQA A-Level Sociology: Exploring Sociology — Revision Notes"
...
description: "Condensed recall notes on agencies of socialisation, formal and informal social control, and positivist vs interpretivist method choice for OxfordAQA A-Level Sociology (9690) Unit 2."
...
|---|---|---|
| Positivist | Structured questionnaires, official statistics, structured observation | Quantifiable, comparable data; models sociology on natural science |
| Interpretivist | Unstructured interviews, participant observation, personal documents | Captures meaning and lived experience |

**Triangulation** — combining quantitative and qualitative methods to offset each one's weaknesses — is the strongest way to end a methods-and-theory answer.

## Worked example: method choice for a research question

"Why do some working-class students underachieve at school?"

```
Positivist:      large-scale official statistics on results by class
                 -- representative, reveals broad patterns, but
                 limited in explaining WHY the pattern exists
Interpretivist:  unstructured interviews/observation with a small
                 group -- reveals lived experience of labelling or
                 subcultural pressure, but limited generalisability
Conclusion:      the choice reflects a genuine theoretical
                 disagreement about what counts as valid sociological
                 knowledge; triangulating both can capture pattern
                 and meaning together
```

Don't just describe both methods — explain that the choice is a *theoretical* one, then propose triangulation.

## Connecting back to Unit 1

Because Unit 2 sits at the end of the International AS, strong answers reuse Unit 1's Families content as worked examples for Unit 2's methodological issues — revise the two units together rather than as fully separate blocks.
