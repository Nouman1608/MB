---
title: "OxfordAQA International A-Level Sociology: Exploring Sociology (9690)"
...
This guide covers **Unit 2 Exploring Sociology**, the second of two
units forming the International AS in OxfordAQA International A-level
...
Completing Units 1 and 2 completes the International AS. The full
International A-level then adds Units 3 to 5 (People and Development,
People and the Environment, and People and Technology), which apply
the sociological perspectives and methodological skills built across
Units 1 and 2 to more applied, contemporary topics.
...
Consider the research question "Why do some working-class students
underachieve at school?" A positivist approach might use large-scale
official statistics on exam results by social class, valued for their
representativeness and ability to reveal broad patterns, but limited in
explaining *why* the pattern exists. An interpretivist approach might
use unstructured interviews or classroom observation with a small
number of students, valued for revealing the lived experience of
labelling, teacher expectation or subcultural pressure, but limited in
how far the findings can be generalised beyond the group studied. A
strong Unit 2 answer does not simply describe both methods -- it
explains that the choice between them reflects a genuine theoretical
disagreement about what counts as valid sociological knowledge, and
may propose triangulating both approaches to capture pattern and
meaning together.
