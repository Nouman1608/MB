...
**Disadvantages:** repeating one task becomes **monotonous, reducing motivation and raising absenteeism and staff turnover**, which can offset the productivity gain [1] [1]. Workers become **dependent on one narrow skill**, so if that job disappears they face **structural unemployment** and are hard to re-employ [1] [1]. (Also accept: the whole production line halts if one stage fails.)
