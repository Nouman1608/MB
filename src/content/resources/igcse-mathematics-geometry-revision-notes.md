---
title: "IGCSE Mathematics: Geometry — Revision Notes"
...
syllabusTopics:
  - qualification: "igcse"
    ...
    subtopic: "geometrical-terms-cambridge-igcse-maths"
  - qualification: "igcse"
    topic: "geometry-cambridge-igcse-maths"
    subtopic: "geometrical-constructions-cambridge-igcse-maths"
  - qualification: "igcse"
    topic: "geometry-cambridge-igcse-maths"
    subtopic: "scale-drawings-cambridge-igcse-maths"
  - qualification: "igcse"
    topic: "geometry-cambridge-igcse-maths"
    subtopic: "similarity-cambridge-igcse-maths"
  - qualification: "igcse"
    topic: "geometry-cambridge-igcse-maths"
    subtopic: "symmetry-cambridge-igcse-maths"
  - qualification: "igcse"
    topic: "geometry-cambridge-igcse-maths"
...
[Geometry practice questions](/resources/igcse-mathematics-geometry-practice/)
...
**Rotational symmetry** (order) counts how many times a shape maps onto itself in one full 360-degree turn. **Line symmetry** counts the number of mirror lines. The two are not always equal -- a regular hexagon has rotational symmetry order 6 and 6 lines of symmetry, but an isosceles (non-equilateral) triangle has rotational symmetry order 1 and only 1 line of symmetry. A (non-rhombus) kite has exactly **one** line of symmetry, along the diagonal joining the two vertices where each pair of equal adjacent sides meets -- this diagonal bisects the angles at those two vertices (which are generally different from each other, not equal). The kite's one pair of equal angles sits at the other two vertices, off this axis, each the reflection of the other rather than bisected by it. For example, the kite with vertices (0,2), (1,0), (0,-1), (-1,0) has its equal-side-meeting vertices at (0,2) and (0,-1), so its symmetry axis is the vertical line through them, not a diagonal through (1,0) and (-1,0).
