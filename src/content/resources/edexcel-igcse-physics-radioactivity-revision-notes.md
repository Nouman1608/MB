---
title: "Edexcel IGCSE Physics: Radioactivity and Particles — Revision Notes"
...
[Radioactivity and Particles study guide](/resources/edexcel-igcse-physics-radioactivity-and-particles/).
...
- **Smoke detector** → **alpha**, because it ionises air strongly but is safely stopped inside the device.
- **Medical tracer** → **gamma**, because it penetrates the body to be detected outside.
