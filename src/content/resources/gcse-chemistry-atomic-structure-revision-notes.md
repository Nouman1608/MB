---
title: "GCSE Chemistry: Atomic Structure and the Periodic Table — Revision Notes"
...
2. **Some were deflected** → the nucleus is **positively charged**, repelling the positive alpha particles.
3. **A very few bounced back** → the nucleus is **very small but contains most of the mass**.
...
1. The outer electron is in a shell **further from the nucleus**.
2. There is **more shielding** by inner shells.
3. So the **attraction between nucleus and outer electron is weaker**, and the electron is lost more easily.
...
5. Why are elements in the same group chemically similar?
