---
title: "IB MYP Sciences: The Four Assessment Criteria in Practice -- Practice Questions"
...
> evidence-evaluation judgment MYP Sciences's assessment actually requires. They
...
Related: [Criteria in Practice study guide](/resources/ib-myp-sciences-criteria-in-practice/) and
...
**(a)** Explain why this answer alone does not demonstrate top-band Criterion A evidence. **[2]**
...
**(a)** Explain why this task, completed exactly as given, is unlikely to generate top-band Criterion B evidence on its own. **[3]**
...
**(a)** Explain why this evaluation is unlikely to reach top band on Criterion C. **[3]**
**(b)** Rewrite it in outline to reflect what top-band evidence would include instead. **[3]**
...
International Baccalaureate Organization, *Middle Years Programme Subject Brief -- Sciences*, from 2014, (c) 2015 -- the same source cited by the [study guide](/resources/ib-myp-sciences-criteria-in-practice/) and [revision notes](/resources/ib-myp-sciences-criteria-in-practice-revision-notes/). Verified 2026-09-06.
