...
description: "Original exam-style practice questions with full worked answers on translation into and out of Urdu, idiom, register and literary response."
...
> تعلیم صرف ڈگری حاصل کرنے کا نام نہیں، بلکہ یہ انسان کے طرزِ فکر کو بدل دیتی ہے۔ جو قوم اپنی بیٹیوں کو تعلیم نہیں دیتی، وہ اپنے آدھے مستقبل سے خود ہاتھ دھو بیٹھتی ہے۔

**[10]**

## Section B — Translation into Urdu
...
## Section C — Language and response
...
> Education is not merely a matter of obtaining a degree; rather, it transforms a person's way of thinking. A nation that does not educate its daughters loses half its own future.

**Marking:** "صرف... کا نام نہیں" rendered as "not merely a matter of" rather than literally "is not the name of" [2]; "بلکہ" correctly conveyed as a contrastive "rather" [1]; "طرزِ فکر" as "way of thinking" or "outlook" [2]; "ہاتھ دھو بیٹھنا" rendered idiomatically as "loses" or "forfeits", **not** as "washes its hands" [3]; overall fluency and correct English register [2].
...
**Marking:** "over the past twenty years" as پچھلے بیس برسوں میں [2]; "risen sharply" as تیزی سے اضافہ ہوا rather than a literal "went up hard" [2]; correct use of the perfect and habitual tenses [2]; "the talent it invested in" rendered with a relative clause (جس پر... سرمایہ لگایا تھا) [2]; gender and verb agreement throughout [2].
