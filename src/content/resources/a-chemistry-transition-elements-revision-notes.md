---
title: "A Level Chemistry: Transition Elements — Revision Notes"
...
1. Ligands approach and **split the degenerate d-orbitals** into two energy levels separated by ΔE.
2. An electron absorbs a photon of energy exactly ΔE and is promoted.
3. That frequency is **removed** from white light; the **complementary** colour is transmitted.
4. `ΔE = hf`, so the colour depends on the size of the split.
...
1. Define a transition element and explain why zinc is excluded.
