...
**5.** H₀: p = 0.10 (defect rate unchanged) [1]; H₁: p > 0.10 (defect rate has increased) — one-tailed, since the question asks specifically about an increase [1]. Under H₀, X ~ B(60, 0.10) [1]. The observed value is 10 defective bulbs; comparing this against the critical region for a one-tailed test at the 5% significance level [1], if 10 falls within the critical region there is sufficient evidence to conclude the true defective rate is greater than 10% [1]; if it does not, there is insufficient evidence to conclude the rate has increased, and the original claim cannot be rejected [1] (accept either conclusion provided it is justified against a correctly identified critical region and stated in context).
