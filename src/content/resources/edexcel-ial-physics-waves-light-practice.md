...
Related: [Waves and the Particle Nature of Light revision notes](/resources/edexcel-ial-physics-waves-light-revision-notes/)
...
**(a)** Calculate the grating spacing d. **[2]**
**(b)** Calculate the angle of the first-order maximum. **[3]**
...
**(b)** Light of frequency 8.0 × 10¹⁴ Hz is shone on the metal. Calculate the maximum kinetic energy of the emitted electrons in joules. **[3]**
**(c)** Explain why increasing the **intensity** of light below the threshold frequency produces no emission, and why this supports the photon model. **[4]**
...
**3. (a)** d = 1 ÷ (500 × 10³) m [1] = **2.00 × 10⁻⁶ m** [1].
**(b)** d sin θ = nλ [1]; sin θ = (1 × 590 × 10⁻⁹) ÷ 2.00 × 10⁻⁶ = 0.295 [1]; θ = **17.2°** [1].
**(c)** Maximum when sin θ = 1 [1]; n = d ÷ λ = 2.00 × 10⁻⁶ ÷ 590 × 10⁻⁹ = 3.39 [1]; so the highest order is **n = 3** [1].
...
**5. (a)** φ = 2.30 × 1.60 × 10⁻¹⁹ = 3.68 × 10⁻¹⁹ J [1]; f₀ = φ ÷ h = 3.68 × 10⁻¹⁹ ÷ 6.63 × 10⁻³⁴ [1] = **5.55 × 10¹⁴ Hz** [1].
**(b)** E = hf = 6.63 × 10⁻³⁴ × 8.0 × 10¹⁴ = 5.30 × 10⁻¹⁹ J [1]; KE_max = E − φ = 5.30 × 10⁻¹⁹ − 3.68 × 10⁻¹⁹ [1] = **1.6 × 10⁻¹⁹ J** [1].
