---
title: "A Level Physics: Medical Physics — Practice Questions"
...
description: "Original exam-style practice questions with full worked answers on ultrasound, X-rays, attenuation and PET scanning for A Level Physics."
...
Related: [Medical Physics revision notes](/resources/a-physics-medical-physics-revision-notes/)
...
**(a)** Calculate the intensity reflection coefficient at a soft tissue–bone boundary. **[3]**
**(b)** Comment on what this means for imaging structures behind bone. **[2]**
...
**(a)** Calculate the fraction of the intensity transmitted. **[3]**
**(b)** Calculate the half-value thickness. **[2]**
...
**3. (a)** (Z₂ − Z₁)² ÷ (Z₂ + Z₁)² = (6.40 − 1.63)² ÷ (6.40 + 1.63)² [1]
= (4.77)² ÷ (8.03)² = 22.75 ÷ 64.48 [1] = **0.353** [1].
**(b)** About **35% of the intensity is reflected** at the boundary [1], so relatively little penetrates further — structures behind bone are **poorly imaged** by ultrasound [1].
