...
Related: [Carboxylic Acids and Esters revision notes](/resources/as-chemistry-carboxylic-acids-esters-revision-notes/) and the [full study guide](/resources/as-carboxylic-acids-and-esters/), which covers all three preparation routes and the LiAlH₄ reduction in more depth.
...
**(b)** The reaction is **reversible and reaches equilibrium**, so it does not go to completion [1]. Use an **excess of one reactant** [1], or **remove the ester by distilling it off as it forms**, which shifts the equilibrium to the right by Le Chatelier's principle [1].
**(c)** **Distil off the ester**, which has the lowest boiling point of the mixture [1], then **shake with sodium carbonate solution to remove acid impurities**, separate, and dry before redistilling to obtain the pure product [1].
