---
title: "A Level Business: Human Resource Management (Cambridge 9609)"
...
This guide covers **Topic 2 Human resource management**, an AS Level
topic for Cambridge International AS & A Level Business 9609,
2026–2028 series (Version 2, no significant changes affecting teaching
from the prior version). AS Level candidates study topics 1.1–5.5; A
Level candidates study all topics 1.1–10.4.

## Where this fits in 9609

Human resource management is the second of five AS Level topics,
following Business and its environment. Where Topic 1 establishes what
a business is trying to achieve and who its stakeholders are, Topic 2
turns to the people who actually carry out that work — how a business
recruits, motivates and manages its workforce. This topic also lays
the groundwork for its A Level counterpart, Topic 7 (Human resource
management), which extends organisational structure, communication,
leadership and HRM strategy at greater depth once AS content is
secure.
...
throughout later AS and A Level topics whenever a scenario involves
how a business's workforce responds to change, so treating this as
foundational knowledge to keep secure, rather than content to revise
once and move past, pays off well beyond this topic's own exam
questions.

## Worked example: applying recruitment to a scenario

A typical exam scenario gives a growing business that needs to fill a
new, specialist role quickly. A strong answer does not simply define
internal and external recruitment — it weighs both against the
specific detail in the scenario: internal recruitment would be faster
and cheaper, and the candidate already understands the business, but
may not bring the specialist skill the new role needs if no existing
employee has it; external recruitment widens the pool of relevant
skills and brings fresh perspectives, but takes longer and carries a
higher cost and a period of adjustment for the new hire. The answer
that reaches a justified recommendation — not just a balanced list —
tends to score most highly, because Business at this level assesses
judgement as much as knowledge.

## Common mistakes to avoid

A recurring pattern across weaker answers on this topic is treating
2.1–2.3 as three separate lists of facts to recall rather than three
connected aspects of how a business manages its people. Recruitment
decisions (2.1) affect who is available to motivate (2.2); motivation
approaches interact with the management style in place (2.3); and a
manager's own style shapes which motivators are practical to use day
to day. Examiners reward answers that draw these connections
explicitly rather than answering each sub-topic in isolation, and a
quick self-check worth applying to any answer on this topic is whether
it explains a *consequence* for the business, not just a definition of
a term.

## Official syllabus

Cambridge International AS & A Level Business 9609 syllabus for 2026,
2027 and 2028 (Version 2, December 2025) —
[cambridgeinternational.org](https://www.cambridgeinternational.org/Images/697371-2026-2028-syllabus.pdf).

## Related resources

- [Business and its Environment](/resources/a-level-business-business-and-its-environment/)
  — the first topic of 9609, a prerequisite for this topic
