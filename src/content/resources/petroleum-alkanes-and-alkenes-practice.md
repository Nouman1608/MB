---
title: "IGCSE Chemistry: Petroleum, Alkanes and Alkenes — Practice Questions"
...
**4. (a)** **Substitution** [1].
**(b)** CH₄ + Cl₂ → CH₃Cl + HCl [2] *(1 mark for correct formulae, 1 mark for balancing).*
**(c)** **Ultraviolet light** (a photochemical reaction) [1].
...
**7. (a)** **Addition** [1].
**(b)** **Ethanol** [1]; catalyst: an **acid catalyst** [1].
