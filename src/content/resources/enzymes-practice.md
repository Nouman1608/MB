...
Related: [Enzymes revision notes](/resources/enzymes-revision-notes/)
...
**(a)** Sketch or describe the expected shape of the graph. **[2]**
**(b)** Explain the increase in rate up to the optimum. **[2]**
**(c)** Explain the sharp decrease above the optimum. **[3]**
**(d)** State **two** variables that must be controlled. **[2]**

**4.** Pepsin works best at pH 2 and amylase at pH 7.

**(a)** Suggest where in the body each is found. **[2]**
**(b)** Explain what happens to amylase at pH 2. **[3]**
...
**3. (a)** The rate **rises to a peak at the optimum**, around 37 °C [1], then **falls steeply to zero** [1].
**(b)** Molecules gain **kinetic energy and move faster** [1], so there are **more frequent successful collisions** between enzyme and substrate [1].
**(c)** The increased vibration **breaks the bonds holding the enzyme's shape** [1]; the **active site changes shape** [1] so the **substrate no longer fits** and no enzyme–substrate complexes form — the enzyme is denatured [1].
**(d)** Any two: **pH**, **enzyme concentration**, **substrate (starch) concentration**, **volume of solution** [1] [1].

**4. (a)** Pepsin — the **stomach**, which contains hydrochloric acid [1]. Amylase — the **mouth or small intestine** [1].
**(b)** The high **H⁺ concentration disrupts the bonds holding the tertiary structure** [1]; the **active site changes shape** [1] and the enzyme is **denatured, so it stops working** [1].
