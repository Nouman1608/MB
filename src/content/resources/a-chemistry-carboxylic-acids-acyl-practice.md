---
title: "A Level Chemistry: Carboxylic Acids and Acyl Chlorides — Practice Questions"
...
Related: [Carboxylic Acids and Acyl Chlorides revision notes](/resources/a-chemistry-carboxylic-acids-acyl-revision-notes/)
...
**5. (a) (i)** `CH₃COCl + H₂O → CH₃COOH + HCl` [1]
**(ii)** `CH₃COCl + C₂H₅OH → CH₃COOC₂H₅ + HCl` [1]
**(iii)** `CH₃COCl + CH₃NH₂ → CH₃CONHCH₃ + HCl` [1]
