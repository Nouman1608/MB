...
description: "Original exam-style practice questions with full worked answers on moles, the ideal gas equation, titrations and percentage yield for OCR A Level Chemistry."
author: "nouman-ahmed"
...
Related: [Amount of Substance revision notes](/resources/ocr-a-level-chemistry-amount-of-substance-revision-notes/)
...
**1.** A sample of pure oxygen gas, O₂, has a mass of 8.00 g (M_r = 32, Avogadro constant = 6.02 × 10²³ mol⁻¹). How many molecules of O₂ does the sample contain?
A) 1.51 × 10²³
B) 3.01 × 10²³
C) 2.41 × 10²⁴
D) 0.25 **[1]**

**2.** In the equation pV = nRT used at A Level, with R = 8.31 J K⁻¹ mol⁻¹, which set of units is correct for p, V and T respectively?
A) atm, m³, °C
B) kPa, cm³, K
C) Pa, m³, K
D) Pa, dm³, °C **[1]**

**3.** 25.0 cm³ of a solution of sodium carbonate, Na₂CO₃, is exactly neutralised by 20.0 cm³ of 0.100 mol dm⁻³ hydrochloric acid: Na₂CO₃ + 2HCl → 2NaCl + H₂O + CO₂. What is the concentration, in mol dm⁻³, of the sodium carbonate solution?
A) 0.0800
B) 0.0400
C) 0.0500
D) 0.100 **[1]**

**4.** A reaction has a percentage yield of 100% but a low atom economy. Which statement correctly explains how this is possible?
A) All of the reactant mass converts into the desired product, but the reaction itself is inefficient in terms of energy
B) The reaction produced more product than theoretically expected, but wasted reagents in a side reaction
C) The percentage yield calculation does not account for the moles of reactant used, unlike atom economy
D) All of the limiting reagent that reacted was converted into the desired product with no losses in the practical procedure, but the balanced equation itself produces significant mass in one or more by-products **[1]**

**5.** A student dissolves 4.00 g of NaOH (M_r = 40) in water and makes the solution up to 250 cm³ in a volumetric flask. What is the concentration of the resulting solution, in mol dm⁻³?
A) 4.00 × 10⁻⁴
B) 16.0
C) 4.00
D) 0.400 **[1]**
...
**1. A)** M_r(O₂) = 32; moles = 8.00 ÷ 32 = 0.25 mol; molecules = 0.25 × 6.02 × 10²³ = **1.51 × 10²³** [1].

**2. C)** In the SI form of the ideal gas equation used with R = 8.31 J K⁻¹ mol⁻¹, pressure must be in pascals (Pa), volume in cubic metres (m³) and temperature in kelvin (K) [1].

**3. B)** Moles HCl = 0.100 × 20.0 ÷ 1000 = 2.00 × 10⁻³ mol. The equation shows 1 mol Na₂CO₃ reacts with 2 mol HCl, so moles Na₂CO₃ = 1.00 × 10⁻³ mol. Concentration = 1.00 × 10⁻³ × 1000 ÷ 25.0 = **0.0400 mol dm⁻³** [1].

**4. D)** A 100% percentage yield means none of the limiting reagent that reacted was lost in the practical procedure (no losses to side reactions, incomplete reaction or purification); a low atom economy instead reflects the stoichiometry of the balanced equation itself, where a large proportion of the total reactant mass is built into unwanted by-products rather than the desired product [1].
