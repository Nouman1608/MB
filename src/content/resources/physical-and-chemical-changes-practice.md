---
title: "IGCSE Chemistry: Physical and Chemical Changes — Practice Questions"
...
**5. (a)** Physical [1] — the sugar is still chemically the same substance, just dispersed among the water particles, and can be recovered unchanged by evaporation [1].
**(b)** Chemical [1] — a new substance (hydrated iron(III) oxide) is formed, with different properties from the original iron [1].
**(c)** Physical [1] — water remains H₂O throughout; only its state changes [1].
