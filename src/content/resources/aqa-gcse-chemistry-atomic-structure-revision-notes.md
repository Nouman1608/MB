---
title: "AQA GCSE Chemistry: Atomic Structure and the Periodic Table — Revision Notes"
...
description: "Condensed recall notes on atomic models, isotopes, electron configuration, group trends and separation techniques for AQA GCSE Chemistry 8462."
...
[Atomic Structure and the Periodic Table study guide](/resources/gcse-aqa-chemistry-atomic-structure-and-periodic-table/).
...
1. Most particles passed straight through → the atom is mostly **empty space**.
2. Some were deflected → the nucleus is **positively charged**.
3. A very few rebounded → the nucleus is **very small and holds most of the mass**.
...
2. There is **more shielding** from inner shells.
3. So the **attraction is weaker** and the electron is lost more easily.
...
1. Give the three alpha-scattering observations and their conclusions.
2. Why is relative atomic mass rarely a whole number?
3. Explain fully why Group 1 reactivity increases down the group.
4. Why does Group 7 reactivity decrease down the group?
5. Which technique separates two liquids, and on what property?
