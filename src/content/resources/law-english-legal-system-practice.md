...
**3. Small claims track** — claims up to **£10,000**, heard informally in the County Court, usually without lawyers, with costs not normally recoverable [1] [1]. **Fast track** — claims between **£10,000 and £25,000**, with a strict timetable and a trial of no more than one day [1] [1]. **Intermediate track** (in force from **1 October 2023**) — typically claims between **£25,000 and £100,000**, but defined by its conditions rather than by value alone: the claim must be suitable for neither the small claims nor the fast track, the trial must be likely to last no more than **three days**, oral expert evidence must be likely to be limited to **two experts per party**, and the claim must be brought by **one claimant against one or two defendants, or by two claimants against one defendant** (CPR r.26.9(7)) [1] [1]. **Multi-track** — the residual track for claims **over £100,000**, or that fail the intermediate track's conditions, together with classes of claim that **must be allocated to it whatever their value**, such as mesothelioma claims and, generally, clinical negligence claims (CPR r.26.9(10)). The clinical negligence exception is narrow: it applies only where the claim would normally be allocated to the intermediate track, the defendant has admitted liability in full in its letter of response under the Pre-Action Protocol for the Resolution of Clinical Disputes, and the defendant has not raised a Limitation Act 1980 defence. Multi-track cases are heard in the County Court or High Court with active case management by the judge [1] [1].
