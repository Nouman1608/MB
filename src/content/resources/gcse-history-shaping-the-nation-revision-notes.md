---
title: "AQA GCSE History: Shaping the Nation — Revision Notes"
...
[Shaping the Nation study guide](/resources/gcse-history-shaping-the-nation-options/).

## Format at a glance

Paper 2 = **one thematic study (Section A)** + **one British depth study including historic environment (Section B)**. Every centre chooses one option from each — confirm your school's exact choices before revising.
...
- **BA. Norman England, c1066–c1100** — Conquest/military aspects, feudal government/Domesday Book, Norman Church/monasticism.
- **BB. Edward I, 1272–1307** — government/Model Parliament, life/legal system, campaigns in Wales/Scotland.
- **BC. Elizabethan England, c1568–1603** — court/female-ruler problem, "Golden Age"/poverty, religious troubles (Mary Queen of Scots, Spanish Armada).
- **BD. Restoration England, 1660–1685** — restored Crown/Catholic plots, Great Plague/Fire of London, land/trade/naval war.

Single 20–40 year period, close focus, three content parts **plus a fourth part: historic environment** (a specific, annually-published site — confirm your current one with your teacher).
...
Practise explaining how political, religious, social and cultural strands of the period connect to each other, not as separate topics — e.g. BC Elizabethan England expects connecting the religious threat from Catholic plots to the political succession question, not revising "religion" and "politics" separately.

## Historic environment — connect it back, don't treat it as separate

Use the [Historic Environment revision notes](/resources/gcse-history-historic-environment-revision-notes/) for the shared site-study skill (location, function, structure, people connected with the site, design). Reliable structure for a question: state the site's key feature → connect it to a specific event/development from the depth study's other three parts → explain what the site reveals about the period's values/society. Naming the feature without connecting it back is the single most common way marks are lost.
...
Because AQA publishes four distinct depth-study options and three distinct thematic-study options for Paper 2, using a revision resource written for the wrong option wastes revision time on content that will not appear on your actual exam paper at all — unlike some qualifications where all candidates sit identical content, Paper 2 candidates across different schools may share nothing in common beyond the paper's format and timing. Confirming your centre's specific choices (and, for the historic environment, the specific site for your examination series, since sites are republished annually) should be the very first step before opening any Paper 2 revision material, this guide included.
...
- Confusing Paper 2's options with Paper 1's period study/wider world depth study options — different named content entirely.

## Self-test

1. What are the two sections of Paper 2, and what does each cover?
2. Name the three thematic study options and the four British depth study options.
3. What structural difference distinguishes Section A from Section B?
4. Give two of AA's named recurring factors.
