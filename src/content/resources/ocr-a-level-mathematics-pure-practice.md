...
description: "Original exam-style practice questions with full worked answers on logarithms, sequences, differentiation, integration and proof."
...
Related: [Pure Mathematics revision notes](/resources/ocr-a-level-mathematics-pure-revision-notes/)
...
**(a)** Find the 20th term. **[2]**
**(b)** Find the sum of the first 20 terms. **[3]**
**(c)** Find the least n for which the sum exceeds 1000. **[4]**
...
**3. (a)** u₂₀ = 7 + 19 × 4 [1] = **83** [1].
**(b)** S₂₀ = 20/2 (7 + 83) [1] [1] = **900** [1].
**(c)** Sₙ = n/2 [14 + 4(n − 1)] = n(2n + 5) [1]. Solve 2n² + 5n − 1000 > 0 [1]; n = (−5 + √(25 + 8000)) ÷ 4 = 21.1 [1]; least n = **22** [1].

**4. (a)** dy/dx = 5(3x² + 1)⁴ × 6x [1] = **30x(3x² + 1)⁴** [1].
**(b)** Product rule: 2x ln x + x² × (1/x) [1] [1] = **2x ln x + x** [1].
**(c)** Quotient rule: [2(x − 3) − (2x + 1)] ÷ (x − 3)² [1] [1] = **−7 ÷ (x − 3)²** [1].
