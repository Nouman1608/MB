---
title: "OxfordAQA International A-Level Psychology: Introductory Topics (9685)"
...
This guide covers **Unit 1 Introductory Topics in Psychology**, one
of two units forming the International AS in OxfordAQA International
AS and A-level Psychology (9685), first teaching September 2018. AS
content (Units 1-2) is 50% of the full A-level content but contributes
40% of final marks; units are resittable. The full A-level adds Unit 3
and the synoptic Unit 4.
...
Each of the three sub-topics is built around named studies and models,
...
against each other. Because units are resittable, it is worth
consolidating Unit 1 thoroughly rather than moving on the moment
content is first covered -- a solid foundation here makes the
Approaches in Psychology content in the synoptic Unit 4 considerably
easier to access later in the course.
...
The **multi-store model** separates sensory, short-term (5-9 items, 18-30 seconds, acoustic) and long-term stores (unlimited, lifetime, semantic). The **working memory model** replaces the unitary short-term store with a central executive directing a phonological loop, visuo-spatial sketchpad and episodic buffer — supported by dual-task studies.
...
```
Conducted in 1950s America, a notably conformist period
