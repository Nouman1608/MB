---
title: "AS Chemistry: Atoms, Molecules and Stoichiometry — Practice Questions"
...
description: "Original exam-style practice questions with full worked answers on the mole, empirical formulae, gas volumes and limiting reagents for AS Chemistry."
author: "nouman-ahmed"
...
Related: [Stoichiometry revision notes](/resources/as-chem-stoichiometry-revision-notes/)
...
**4. (a)** C: 40.0 ÷ 12.0 = 3.33; H: 6.7 ÷ 1.0 = 6.7; O: 53.3 ÷ 16.0 = 3.33 [1]
Divide by smallest: 1 : 2.01 : 1 [1]
...
**(b)** n(CaO) = 0.0400 mol; M_r = 56.1 [1]
m = 0.0400 × 56.1 = **2.24 g** [1].
...
**6. (a)** n(CH₄) = 3.20 ÷ 16.0 = 0.200 mol [1]; n(O₂) = 16.0 ÷ 32.0 = 0.500 mol [1].
Divide by coefficients: CH₄ 0.200 ÷ 1 = 0.200; O₂ 0.500 ÷ 2 = 0.250. **Methane is limiting** [1].
