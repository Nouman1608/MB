...
**(b)** Hence find the possible values of k. **[2]**
...
**3. (a)** Equal roots means the discriminant is zero: (k + 3)² − 4 × k × 4 = 0 [1]; k² + 6k + 9 − 16k = 0 [1]; **k² − 10k + 9 = 0** [1].
**(b)** (k − 1)(k − 9) = 0 [1]; k = **1 or 9** [1].
