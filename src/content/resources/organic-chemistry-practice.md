---
title: "IGCSE Chemistry: Organic Chemistry — Formulae and Naming — Practice Questions"
...
**5. (a)** Add **bromine water** [1]. Ethene **decolourises** it from orange to colourless [1]; ethane produces **no change** [1].
**(b)** Ethene contains a **C=C double bond** [1] which can undergo an **addition reaction** with bromine [1].

**6. (a)** The fractions have **different boiling points** [1], so they condense at different heights in the column [1].
