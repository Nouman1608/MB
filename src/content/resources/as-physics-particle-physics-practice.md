---
title: "AS Physics: Particle Physics — Practice Questions"
...
description: "Original exam-style practice questions with full worked answers on quarks, leptons, conservation rules and beta decay for Cambridge AS & A Level Physics 9702."
...
**4. (a)** u = +2/3, d = −1/3 each [1].
Total = (+2/3) + (−1/3) + (−1/3) = **0** [1].
...
**6. (a)** Charge: +1 → 0 + 1 + 0 = +1 ✓ [1].
Baryon number: 1 → 1 + 0 + 0 = 1 ✓ [1].
Lepton number: 0 → 0 + (−1) + (+1) = 0 ✓ [1].
