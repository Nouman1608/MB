---
title: "Cambridge A Level English Language 9093: Paper 2 — Revision Notes"
...
description: "Condensed recall notes on Paper 2 structure, Section A shorter writing and reflective commentary, and Section B extended writing for Cambridge International AS & A Level English Language 9093."
author: "marlbridge-academic-team"
publishedDate: 2026-09-03
featured: false
---

Condensed for the final weeks. For the full explanation, use the [Paper 2 Writing study guide](/resources/a-level-english-language-paper-2-writing/).
...
Papers 1 and 2 are the AS content; 3 and 4 complete the A Level. No dictionaries allowed.
...
Paper 2 shares its knowledge and understanding content directly with Paper 1 — the same awareness of textual forms, linguistic features and audience that Paper 1 asks you to *analyse*, Paper 2 asks you to *apply* in your own writing. Revising the two together, rather than as unconnected papers, reinforces both.

## Planning discipline

Because both sections have tight word limits (400 for 1(a), 600–900 for Section B), planning before writing is not optional — a plan for 1(a) should fix the structure (opening, 2–3 developed points, closing) before a single sentence is drafted, and the same applies to Section B regardless of which option is chosen. Writing without a plan is the single most common reason a response drifts off the word range or loses control of structure partway through.

## Worked example: a compressed Section A plan

Brief: a leaflet for new employees on managing their first week at work. A compressed plan under time pressure might be:

```
Opening: reassuring, direct address ("you")
Point 1: practical (where things are, who to ask)
Point 2: social (introducing yourself, team culture)
Closing: a specific next step (a named contact or resource)
```

Even a plan this brief, jotted in under a minute, prevents the piece from drifting and gives part (b) concrete choices to reflect on — three or four headed points beat one continuous, unstructured block every time under this word limit.

## Building commentary sentences quickly
