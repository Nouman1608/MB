---
title: "IGCSE Chemistry: Practical Techniques — Titrations, Chromatography and Separation — Practice Questions"
...
**4. (a)** Spot the mixture near the base of a strip of chromatography paper, above the level of the solvent [1]; stand the paper in a suitable solvent and allow the solvent to rise, carrying the components different distances [1].
**(b)** A **pure** dye produces **exactly one spot**; a mixture separates into **two or more spots** [1].

**5. (a)** Rf = 6.0 / 8.0 [1] = **0.75** [1].
**(b)** The substance can **never travel further than the solvent itself** [1].
