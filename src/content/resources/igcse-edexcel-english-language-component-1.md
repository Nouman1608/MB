---
title: "Edexcel IGCSE English Language: Component 1 (4EA1)"
...
Component 1 pairs reading and writing around the same broad genre —
non-fiction — testing reading comprehension and analysis skills in
Section A, then transactional (purpose-driven, real-world) writing
...
Section A rewards precision over volume — quoting a short, well-chosen
piece of textual evidence and explaining its specific effect
consistently scores higher than a longer answer that only paraphrases
the text or quotes without analysing the language choice itself. A
...
well-written the prose is in the abstract, since content/organisation
marks specifically credit fitness for purpose, not general writing
quality alone. Building a mental checklist
of purpose, audience and form for each piece of practice writing, and
reviewing it before submitting an answer, is a simple habit that
directly targets how this section is actually marked.

Both sections are timed within the same paper, so practising complete Component 1 papers under exam conditions — not just isolated Section A or Section B exercises — is what actually builds the pacing and switching-between-skills that the real exam demands. Switching from close analytical reading (Section A) to fluent, purpose-driven writing (Section B) within a single timed sitting is itself a skill that isolated practice of either section alone does not develop.
...
A transactional writing task specifies all three of purpose, audience and form in the question
itself, and strong answers reflect all three consistently throughout the response, not just in an
opening line. A letter to a newspaper editor, for instance, needs a different register and structure
from a speech to a school assembly, even where both are persuasive in purpose — the audience and
form change how that persuasive purpose should actually be expressed. Before starting to write,
briefly noting the specified purpose, audience and form, and checking the finished response against
