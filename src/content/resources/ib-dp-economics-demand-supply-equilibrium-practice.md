...
description: "Original SL-level practice questions with full worked answers on demand, supply and competitive market equilibrium for IB Diploma Programme Economics."
...
**1.** Define "ceteris paribus" and explain why it matters when stating the law of demand. **[3]**

**2.** State whether each of the following causes a movement along, or a shift of, the demand curve for coffee:
**(a)** the price of coffee rises
**(b)** a new study links coffee to health benefits, increasing consumer preference for it
**(c)** the price of tea (a substitute) falls **[3]**

## Section B

**3.** Using a demand and supply diagram, explain what happens to the equilibrium price and quantity of umbrellas if a period of unusually heavy rainfall increases consumer demand for umbrellas, with supply unchanged. **[8]**
