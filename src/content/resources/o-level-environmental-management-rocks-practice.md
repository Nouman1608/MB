...
**2. Igneous** — **granite**, used for building stone and kerbstones [1] [1]. **Sedimentary** — **limestone**, used to make cement and as a flux in iron smelting [1] [1]. **Metamorphic** — **marble**, used for sculpture and decorative flooring; or slate for roofing [1] [1].
...
**4. Open-cast advantages:** it is **cheaper and faster**, since no shafts or tunnels are needed [1]; it is **far safer for workers**, with no risk of roof collapse or gas [1]; a **higher proportion of the ore can be recovered**.
**Open-cast disadvantages:** it **destroys a very large surface area**, removing vegetation, habitat and topsoil [1]; it produces **enormous visual scarring, dust and noise** affecting nearby communities [1].
**Underground advantages:** it has a **much smaller surface footprint**, so land use above is largely unaffected [1]; it can **reach deep deposits that open-cast cannot economically access** [1].
**Underground disadvantages:** it is **far more expensive and slower** [1]; it is **dangerous** — roof falls, flooding, gas and dust diseases — and **subsidence** can damage buildings at the surface [1].
