...
Related: [Metals and Extraction revision notes](/resources/alloys-and-extraction-revision-notes/)
...
**(a)** State the three raw materials added. **[3]**
**(b)** Write the equation for the reduction of iron(III) oxide by carbon monoxide. **[1]**
**(c)** Explain the purpose of the limestone, including an equation. **[3]**

**4.** Aluminium is extracted by electrolysis rather than by reduction with carbon.

**(a)** Explain why. **[2]**
**(b)** Write the half-equation at the cathode. **[1]**
**(c)** Explain why cryolite is added. **[2]**
**(d)** Explain why the anodes must be replaced regularly. **[2]**
