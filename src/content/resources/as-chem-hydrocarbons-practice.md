---
title: "AS Chemistry: Alkanes and Alkenes — Practice Questions"
...
Related: [Alkanes and Alkenes revision notes](/resources/as-chem-hydrocarbons-revision-notes/)
...
**(a)** Name the mechanism. **[1]**
**(b)** Give the two possible products and identify the major one. **[2]**
**(c)** Explain, using carbocation stability, why one product predominates. **[3]**
...
**2. (a)** **Free radical substitution** [1].
**(b)** Initiation: `Cl₂ → 2Cl•` (UV light) [1].
Propagation: `Cl• + CH₄ → •CH₃ + HCl` [1] and `•CH₃ + Cl₂ → CH₃Cl + Cl•` [1].
Termination: any two radicals combining, e.g. `•CH₃ + Cl• → CH₃Cl` [1].
**(c)** The chlorine radical can attack the **product as well as the starting material** [1], giving further substitution to CH₂Cl₂, CHCl₃ and CCl₄ [1].
...
**4. (a)** **Electrophilic addition** [1].
**(b)** 1-bromobutane and 2-bromobutane [1]; **2-bromobutane** is the major product [1].
**(c)** The mechanism proceeds via a **carbocation intermediate** [1]. The **secondary** carbocation is more stable than the primary [1], because the **electron-donating alkyl groups** on either side spread the positive charge [1].
