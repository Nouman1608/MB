...
**4.** **Actus reus** is the guilty act (the conduct, circumstances and/or consequences that make up the offence); **mens rea** is the guilty mind (the mental element, such as intention or recklessness) [1] [1]; and generally the two must coincide in time for liability to arise [1]. Omissions liability arises only in defined situations: e.g. where a **duty arises from a contract** (an employee whose job it is to act) [1] [1], or where the defendant's **own prior act created a dangerous situation** and they failed to take reasonable steps to counter it once aware of the danger [1] [1]. (Also accept: a duty arising from a relationship, such as parent and child.)
