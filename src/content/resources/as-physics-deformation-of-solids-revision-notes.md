...
The **elastic limit** is where behaviour changes from elastic to plastic. It comes *after* the limit of proportionality, not before.
...
**Strong** means high breaking stress. **Stiff** means high Young modulus. **Tough** means it absorbs a lot of energy before breaking. These are three different properties and questions rely on the distinction — glass is stiff and strong but not tough.
