---
title: "AS Physics: Waves — Practice Questions"
...
Related: [Waves revision notes](/resources/as-physics-waves-revision-notes/)
...
**(a)** Calculate the wavelength. **[2]**
**(b)** Calculate the period. **[2]**
**(c)** Two points on the wave are 0.34 m apart. Calculate their phase difference in degrees. **[3]**
...
**4. (a)** λ = v ÷ f = 340 ÷ 250 [1] = **1.36 m** [1].
**(b)** T = 1 ÷ f = 1 ÷ 250 [1] = **4.0 × 10⁻³ s** [1].
**(c)** 0.34 ÷ 1.36 = 0.25 wavelengths [1] [1]
Phase difference = 0.25 × 360 = **90°** [1].
