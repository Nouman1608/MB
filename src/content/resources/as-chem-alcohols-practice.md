---
title: "AS Chemistry: Alcohols — Practice Questions"
...
**(a)** State the product and conditions if you **distil**. **[2]**
**(b)** State the product and conditions if you **reflux**. **[2]**
**(c)** State the colour change observed. **[1]**
**(d)** State what happens if 2-methylpropan-2-ol is treated the same way, and explain. **[2]**
