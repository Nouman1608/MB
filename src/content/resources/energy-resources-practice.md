...
Related: [Energy Resources revision notes](/resources/energy-resources-revision-notes/) and the [full study guide](/resources/energy-resources-and-efficiency/), which covers biofuels and the complete power-generation table.
...
**Environmental:** **no emissions in operation** [1]; manufacturing the panels has an environmental cost, and land is required [1].
...
**7. (a)** E = Pt = 2200 × 180 [1] [1] = **396 000 J** [1].
**(b)** E = mcΔθ = 0.80 × 4200 × 65 [1] = **218 400 J** [1].
**(c)** 218 400 ÷ 396 000 [1] = **0.55 or 55%** [1].
