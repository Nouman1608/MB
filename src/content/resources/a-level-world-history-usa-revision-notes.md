---
title: "A Level World History: The History of the USA, 1820-1941 — Revision Notes (Cambridge 9489)"
...
- Causes of the 1929 Crash: speculative excess, structural banking/agricultural weaknesses, limits of
  1920s prosperity.
- Evaluate New Deal measures individually — some addressed relief, some recovery, some longer-term
  reform. Never treat "the New Deal" as one undifferentiated policy.
...
expansion), and reach a supported judgement backed by specific evidence (a named event, law, or
political crisis) rather than a general assertion. This kind of weighed, evidence-based judgement is
what both papers reward most highly, over a balanced list with no conclusion.

## Worked example: evaluating the New Deal

Consider a question asking candidates to evaluate the success of the New Deal. A weak response treats
the New Deal as a single policy and asserts it either succeeded or failed as a whole. A stronger
response distinguishes specific measures by their intended aim: relief measures (such as direct
emergency aid to the unemployed) can be judged on how quickly and widely they reduced immediate
hardship; recovery measures (aimed at reviving economic activity) can be judged against economic
indicators over time; and reform measures (aimed at preventing a future crash, such as new financial
regulation) can be judged on their longer-term structural impact rather than immediate results. A
...
- Treating the Civil War's causes as a simple checklist rather than interlocking factors.
- Describing Reconstruction only in terms of policy, without the lived reality for formerly enslaved
  people.
- Discussing Gilded Age problems without connecting them to specific Progressive Era reforms.
- Explaining the 1929 Crash as a sudden, isolated event rather than the product of 1920s structural
  weaknesses.
- Treating the New Deal as one uniform policy rather than distinct relief/recovery/reform measures.

## Self-test

1. Name three interlocking causes of the Civil War.
2. What is the central unresolved question of Reconstruction, per this option?
3. Give one named Progressive Era reform (in general terms — any legitimate example).
4. Name two causes of the 1929 Wall Street Crash.
5. Name the three broad aims the New Deal's measures should be evaluated against.

**Answers:** 1. Expansion of slavery into new territories, North-South economic divergence, federal vs
state power disputes. 2. What freedom and citizenship would actually mean for formerly enslaved people.
3. E.g. antitrust/trust-busting legislation, labour/working-condition reforms, consumer protection laws
(any specific, named example). 4. Speculative excess and structural banking/agricultural weaknesses (or
the limits of 1920s prosperity). 5. Relief, recovery, reform.
