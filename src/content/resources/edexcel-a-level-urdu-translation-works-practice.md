---
title: "A Level Urdu: Translation into Urdu and Written Response to Works — Practice Questions"
...
**7. (a)** This allocation leaves only 1 hour 50 minutes (55 minutes each) for two responses that the recommended timing allocates roughly 1 hour 5 minutes each -- since Sections B and C together carry 90 of the paper's 110 marks (the bulk of the total), under-time on these sections risks losing more marks than the 20 minutes saved on Section A's translation (worth only 20 marks) could ever make up for. **[3]**
