...
**Intensity ∝ amplitude²** — doubling the amplitude quadruples the intensity. And intensity ∝ 1/r² for a point source.
...
Only transverse waves can be polarised — the standard reason sound cannot be.
...
Visible light: roughly 400 nm (violet) to 700 nm (red). All EM waves are **transverse**, travel at **3.00 × 10⁸ m/s** in a vacuum, and are progressive transfers of energy.
...
**Answers:** 1. v = fλ; f = 1/T. 2. Light is transverse, so oscillations occur in many planes perpendicular to travel and one plane can be selected; sound is longitudinal, oscillating parallel to travel, so there is no plane to filter. 3. It quadruples (I ∝ A²). 4. Radio, microwave, infrared, visible, ultraviolet, X-ray, gamma. 5. It rises — the wavefronts ahead of the source are compressed, shortening the observed wavelength and raising the observed frequency, although the source frequency is unchanged.
