---
title: "OCR A Level Economics: Microeconomics — Revision Notes"
...
**Short run:** at least one factor fixed, so the **law of diminishing returns** eventually raises marginal cost.
**Long run:** all factors variable, so **economies and diseconomies of scale** shape the average cost curve.
