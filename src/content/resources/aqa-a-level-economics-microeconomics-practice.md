---
title: "AQA A Level Economics: Individuals, Firms, Markets and Market Failure — Practice Questions — Practice Questions"
...
**4. Price and output:** in perfect competition the firm is a **price taker** and price equals marginal cost; in monopoly the firm is a **price maker** and sets a **higher price and lower output** [1] [1].
**Allocative efficiency:** perfect competition achieves **P = MC**, so it is allocatively efficient; monopoly sets **P > MC**, so it is allocatively inefficient and creates a deadweight welfare loss [1] [1].
**Productive efficiency:** perfect competition produces at the **minimum of AC** in the long run; monopoly need not, so may be productively inefficient — X-inefficiency may also arise from the absence of competitive pressure [1] [1].
