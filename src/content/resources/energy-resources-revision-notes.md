...
**Renewable** — replenished naturally: solar, wind, hydroelectric, tidal, wave, geothermal, biofuels.

## Comparison table

The syllabus limits "advantages and disadvantages" to **three factors only**:
whether the resource is **renewable**, **when/whether it is available**, and
its **environmental impact**. Cost, reliability and public opinion are **not
creditable** — the table below is built on the three permitted factors only.
