---
title: "IB Diploma Programme Language B: Syllabus Guide"
resourceType: "study-guides"
subject: "language-b"
level: ["ib"]
topic: "Full syllabus (five prescribed themes)"
boards: ["ib"]
...
Language B**, first assessment 2020, for both Standard Level (SL) and
Higher Level (HL) students. It complements the
[subject overview](/resources/ib-dp-language-b-subject-guide/) and the
[assessment revision notes](/resources/ib-dp-language-b-assessment-revision-notes/)
already on the site by setting out what the course actually studies --
the five prescribed themes shared with Language ab initio, and how
Language B builds on them at a more advanced level of the target
language.

Unlike a course built from separate numbered units, Language B's
content is organised entirely around five broad, recurring themes,
each explored through written, audio, visual and audio-visual texts in
the target language. Each theme carries a guiding principle that frames
its recommended topics, and the syllabus brief itself models the kind
of open, discussion-driving questions a theme should generate --
useful as a starting point for structuring both classroom discussion
and independent revision.

## Identities

Explores the nature of the self and what it is to be human. Recommended
topics include lifestyles, health and well-being, beliefs and values,
subcultures, and language and identity. A guiding question the theme
returns to repeatedly: how do language and culture contribute to
forming an identity?

## Experiences

Explores and tells the stories of the events, experiences and journeys
that shape our lives. Recommended topics include leisure activities,
holidays and travel, life stories, rites of passage, customs and
traditions, and migration. This theme asks how the past shapes the
present and future, and how different cultures mark important moments
in life.

## Human ingenuity

Explores the ways human creativity and innovation affect our world.
Recommended topics include entertainment, artistic expressions,
communication and media, technology, and scientific innovation. It
asks what a culture's artistic expression reveals about it, and how
media change the way people relate to each other.

## Social organization

Explores the ways groups of people organize themselves, or are
organized, through common systems or interests. Recommended topics
include social relationships, community, social engagement, education,
the working world, and law and order. It asks what role an individual
plays within a community, and what role rules and regulations play in
forming a society.

## Sharing the planet

Explores the challenges and opportunities faced by individuals and
communities in the modern world. Recommended topics include the
environment, human rights, peace and conflict, equality, globalization,
ethics, and urban and rural environments. It asks what environmental
and social challenges the world faces and how they might be overcome,
and what challenges and benefits globalization brings.
...
Because all five themes are compulsory and are examined through unseen
material in Paper 2 (listening and reading), build genuine, broad
vocabulary and comprehension practice across all five rather than
...
recall developed over time rather than last-minute rereading.

Language B sits within group 2, language acquisition, alongside
Language ab initio -- the two share the same five themes and aims, and
schools choose between them based on how much prior experience of the
target language their students bring, with Language B intended for
students who already have some background in it.

## Official syllabus

International Baccalaureate Organization, *Diploma Programme Subject
Brief -- Language B*, first assessment 2020, © 2018.
