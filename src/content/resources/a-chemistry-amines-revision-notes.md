---
title: "A Level Chemistry: Amines — Revision Notes"
...
description: "Condensed recall notes on amine basicity, preparation, reactions and the comparison of aliphatic and aromatic amines for Cambridge A Level Chemistry 9701."
author: "nouman-ahmed"
...
[Amines study guide](/resources/a-amines-aliphatic-and-aromatic/).

## Basicity — the central comparison

Amines are bases because the **lone pair on nitrogen accepts a proton**.

**Base strength order:**

```
secondary aliphatic > primary aliphatic > ammonia > aromatic (phenylamine)
```

The explanation must be about **electron density on the nitrogen lone pair**:
...
```
halogenoalkane + excess NH3 (ethanolic, heated under pressure) -> primary amine
```

**Excess ammonia is essential**, because the primary amine formed is itself nucleophilic and reacts further to give secondary, tertiary and quaternary products. Excess ammonia makes further substitution statistically less likely.
...
```
benzene --conc HNO3/conc H2SO4, 55 C--> nitrobenzene
nitrobenzene --Sn/conc HCl, then NaOH--> phenylamine
```

**The NaOH step is essential and commonly omitted**: the reduction produces the phenylammonium salt, and NaOH is needed to liberate the free amine.

## Reactions

**As a base:** with acids to form salts — `RNH₂ + HCl → RNH₃⁺Cl⁻`.

**As a nucleophile:** with halogenoalkanes to form secondary amines; with acyl chlorides to form **N-substituted amides**.
...
```
phenylamine + HNO2 (NaNO2 + HCl) at BELOW 10 C  ->  diazonium salt
diazonium salt + phenol in alkali  ->  AZO DYE (coloured)
```

**The temperature requirement is a mark:** above 10 °C the diazonium salt decomposes. The azo coupling produces an extended **delocalised system**, which absorbs visible light — this is why azo compounds are intensely coloured and used as dyes.
...
- Forgetting excess ammonia in the halogenoalkane route.
...
1. Why are amines basic?
2. Why is a secondary aliphatic amine a stronger base than ammonia?
