---
title: "OxfordAQA International A-Level Sociology (9690): Preparing for a Brand-New Specification"
resourceType: "exam-preparation"
subject: "sociology"
level: ["a-levels"]
topic: "Exam preparation -- AS Units 1-2 and A-level Units 3-5"
boards: ["oxfordaqa"]
...
Unlike many modular qualifications where A-level units outweigh AS units, all five of 9690's units carry
exactly 20% each. **Exam-preparation priority**: revise all five topics to comparable depth rather than
assuming the later A-level units matter more, since the weighting gives no unit priority over another.

## Research Methods runs through both AS units

Both AS Unit 1 (Families) and AS Unit 2 (Socialisation and Social Control) pair their substantive topic
with Research Methods content. **Exam-preparation priority**: treat research methods as a single
cumulative thread across both AS units rather than two separate topics, since the same methodological
concepts -- sampling, validity, reliability, ethics -- recur in both.

## Applying sociological theory to named studies is the core evaluative skill
...
Identify the theorist or study precisely before evaluating it.

Step 2 - explain what evidence or reasoning supports the claim:
The basis for taking the claim seriously in the first place.

Step 3 - give a specific criticism, not a generic one:
Tied to this theory or study's own method, sample or assumptions
-- not a stock criticism that could apply to anything.

Step 4 - introduce a contrasting perspective:
A different theoretical tradition or a later study that complicates
the original claim.

Step 5 - conclude what the balance of evidence supports:
Directly answering the essay question's own terms, not a general
...
- **In every evaluative paragraph**: state the claim, give supporting evidence, offer a specific (not
  generic) criticism, introduce a contrasting perspective, and conclude against the question's own terms.
...
method, sample or assumptions, rather than a generic point that could be raised against almost any study.
