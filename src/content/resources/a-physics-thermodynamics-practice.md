---
title: "A Level Physics: Thermodynamics — Practice Questions"
...
description: "Original exam-style practice questions with full worked answers on internal energy, the first law, specific heat capacity and latent heat for Cambridge AS & A Level Physics 9702."
...
Related: [Thermodynamics revision notes](/resources/a-physics-thermodynamics-revision-notes/)
...
*Both components are needed. "The total kinetic energy" scores one at most.*
...
**4. (a)** W = **+250 J** (work done **on** the gas) [1]; q = **−80 J** (thermal energy **lost**) [1].
ΔU = 250 + (−80) = **+170 J** [1].
