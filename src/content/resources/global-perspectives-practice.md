...
**1.** Explain the difference between a **fact**, an **opinion** and a **reasoned argument**. **[3]**

**2.** State the three perspectives you are expected to consider and explain what each means. **[3]**

## Section B

**3.** A source states: *"A recent survey by an airline industry association found that 78% of travellers believe aviation is unfairly blamed for climate change."*
...
- Evaluating a source by saying only "it might be biased" without identifying the interest.
- Confusing a consequence with a cause.
- Proposing a course of action without evaluating it.
- Writing a conclusion that summarises rather than judges.
