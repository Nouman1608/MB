...
description: "Condensed recall notes on orbitals, electron configuration and ionisation energy trends for Cambridge International AS & A Level Chemistry 9701."
author: "nouman-ahmed"
...
[Atomic Structure: Orbitals and Ionisation Energy study guide](/resources/as-atomic-structure-orbitals-and-ionisation-energy/).
...
| Dip | Explanation |
|---|---|
| **Al < Mg** | Al's outer electron is in a **3p** orbital, higher in energy and more shielded than Mg's 3s |
| **S < P** | In sulfur, **two electrons share one 3p orbital** and repel each other, so one is more easily removed |
