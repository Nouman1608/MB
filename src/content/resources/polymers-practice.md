...
syllabusTopics:
  ...
  - qualification: "o-level"
    topic: "organic-chemistry"
    subtopic: "polymers"
description: "Original exam-style practice questions with full worked answers on addition polymers, repeat units, disposal and condensation polymers."
author: "nouman-ahmed"
...
Related: [Polymers revision notes](/resources/polymers-revision-notes/)
...
**5. Landfill** — cheap and simple [1]; but uses up land and the plastic remains for centuries, and toxic additives may leach out [1].
**Incineration** — reduces volume greatly and the **heat can generate electricity** [1]; but produces **carbon dioxide and, from PVC, toxic gases such as hydrogen chloride and dioxins** [1].
**Recycling** — **conserves crude oil as a finite raw material and reduces landfill** [1]; but plastics must be **sorted by type**, which is labour-intensive and costly, and the recycled material is often of lower quality [1].
