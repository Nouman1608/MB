...
syllabusTopics:
  ...
  - qualification: "o-level"
    topic: "organic-chemistry"
    subtopic: "naming-organic-compounds"
description: "Condensed recall notes on homologous series, functional groups, isomerism and naming organic compounds for Cambridge IGCSE 0620 and O Level 5070."
author: "nouman-ahmed"
...
[Organic Chemistry: Formulae and Naming study guide](/resources/organic-chemistry-formulae-and-naming/).
...
Same formula, different structure, therefore different physical properties (branched isomers have lower boiling points — less surface contact between molecules).

## Saturated vs unsaturated

- **Saturated** — only single C–C bonds (alkanes).
- **Unsaturated** — contains C=C (alkenes).

**Test:** add **bromine water**. Orange-brown → **colourless** indicates unsaturation (alkene). No change = saturated.

This is the single most examined organic test.
