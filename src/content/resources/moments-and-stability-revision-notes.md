---
title: "Elastic Deformation, Moments and Centre of Gravity: Revision Notes"
...
[Elastic Deformation, Moments and Centre of Gravity study guide](/resources/elastic-deformation-moments-and-centre-of-gravity/).
...
Extension is proportional to load **up to the limit of proportionality**. Beyond it the graph curves; beyond the **elastic limit** the spring no longer returns to its original length.
...
A moment is the turning effect of a force. It is zero if the force acts through the pivot, or along the line of the pivot.
...
For a symmetrical uniform object, it is at the geometric centre.
...
Practical examples: racing cars (low, wide), Bunsen burners (heavy base), double-decker buses (low centre of gravity by design).
...
1. A spring of natural length 12 cm extends to 18 cm under 3 N. Find k.
2. State the principle of moments.
3. A 40 N force acts 0.25 m from a pivot. Find the moment.
