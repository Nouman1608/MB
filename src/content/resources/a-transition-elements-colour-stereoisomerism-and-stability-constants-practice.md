---
title: "A Level Chemistry: Colour, Stereoisomerism and Stability Constants — Practice Questions"
...
Related: [Transition Elements: Colour, Stereoisomerism and Stability Constants revision notes](/resources/a-transition-elements-colour-stereoisomerism-and-stability-constants/)
...
**2.** Ti³⁺ is **d¹** [1]. Since it has one d electron that can be promoted (and a vacancy to promote into), it **can be coloured** [1].

**3. Two higher-energy** orbitals and **three lower-energy** orbitals [2].
*The reverse split (three higher, two lower) applies to tetrahedral complexes, not octahedral — a very common mix-up.*
