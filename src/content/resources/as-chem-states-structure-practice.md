---
title: "AS Chemistry: Ideal Gases and Structure — Practice Questions"
...
description: "Original exam-style practice questions with full worked answers on the ideal gas equation, kinetic theory and giant structures for AS Chemistry."
author: "nouman-ahmed"
...
Related: [Ideal Gases and Structure revision notes](/resources/as-chem-states-structure-revision-notes/)
...
**(a)** Convert the volume to m³ and the temperature to K. **[2]**
**(b)** Calculate the number of moles. **[3]**
**(c)** The mass of the gas is 0.482 g. Calculate its relative molecular mass. **[2]**
...
**(b)** n = pV ÷ RT = (1.20 × 10⁵ × 2.50 × 10⁻⁴) ÷ (8.31 × 300) [1]
= 30.0 ÷ 2493 [1] = **0.01203 mol** [1].

**(c)** M = m ÷ n = 0.482 ÷ 0.01203 [1] = **40.1** [1].

**3.** At **high pressure**, the molecules are close together so their **own volume is no longer negligible** compared with the container [1] [1]. At **low temperature**, the molecules move slowly so **intermolecular attractions are no longer negligible** [1] [1].
*These are precisely the two assumptions of the model that fail.*
