...
Related: [English Language revision notes](/resources/oxfordaqa-english-language-revision-notes/)

---

## Section A — Reading

**1.** Explain what is meant by **inference**, and how it differs from retrieval of explicit information. **[3]**
...
**(b)** Analyse the effect of the personification in the second clause. **[3]**
**(c)** Comment on the structural effect of joining the two clauses with "and". **[2]**
...
**1. Retrieval** means finding **information stated directly in the text** [1]. **Inference** means **working out what is implied but not stated**, using clues in the writing [1]; for example, a text that says a character "checked the lock twice" does not state anxiety but implies it [1].

**2.** Make a **point** answering the question; provide a **short embedded quotation** as evidence; then **explain how the specific words create the effect and what the reader is led to feel or understand** [1] [1] [1]. The most common weakness is that the **explanation merely restates the quotation** rather than analysing the writer's choices — the explanation should be the longest part [1].

**3. (a)** "Spilled" suggests the light is **liquid and uncontained**, moving of its own accord rather than being directed [1]; it implies **excess and mess**, so the city seems disordered rather than glamorous [1], and it links visually to the wetness of the tarmac, unifying the image [1].
**(b)** Personifying the street as **holding its breath** attributes **fear and anticipation to the place itself** [1], so the tension belongs to the whole city rather than to any individual [1]; "held" also suggests a **deliberate, temporary stillness**, implying the calm will not last [1].
**(c)** The **coordinating conjunction places the two images on an equal footing** rather than subordinating one [1], creating an accumulating, unhurried rhythm that mirrors the pause the sentence describes [1].
