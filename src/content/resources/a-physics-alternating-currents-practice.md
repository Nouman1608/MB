---
title: "A Level Physics: Alternating Currents — Practice Questions"
...
Related: [Alternating Currents revision notes](/resources/a-physics-alternating-currents-revision-notes/)
...
**(c)** I_rms = P ÷ V_rms = 1150 ÷ 230 [1] = **5.0 A** [1].
I₀ = 5.0 × √2 = **7.07 A** [1].
...
**(c)** Any two, each with its remedy:
**Eddy currents** in the core dissipate energy [1] — reduced by **laminating** the core with insulated layers [1].
**Resistive (I²R) heating** in the windings [1] — reduced by using **thick, low-resistance copper wire** [1].
*(Also acceptable: hysteresis, reduced by using a soft iron core; flux leakage, reduced by better core design.)*
