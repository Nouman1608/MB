...
| | |
|---|---|
| findings recorded | 1,738 |
| confirmed errors open | **2 groups** (E922, round 22, D-244 not yet read; E923, round 23) *(reconciliation current through **D-243**; every closure from D-226 to D-243 read. 515 closures in D-138…D-225 were sampled, not read. **Not a statement that the resources are correct.**)* |
