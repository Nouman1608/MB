...
| `2026-10-30-findings.md` | Round 23: 78 IB board claims checked (59 supported) and D-241's 22 IB settlements confirmed. E923 (7), I372 (8), U74 (6). **2 confirmed-error groups open** (E922 pending D-244's read; E923). |
| `2026-10-31-findings.md` | Round 24: D-244 read — **17 of 17 fixed**; E922, I371 and U73 closed. I373 (5 items from D-244's observations). **1 confirmed-error group open** (E923). |
...
| `2026-11-05-findings.md` | Round 29: D-249 read — **2 of 2 fixed**; E925 and I376 closed (residue I378). 40 more D-138…D-225 closures read — **40 of 40 fixed**. Leads worked: I379 (11 items). **0 confirmed-error groups open.** |
| `2026-11-06-findings.md` | Round 30 (1 of 5): 95 unread D-138…D-225 closures read (E47–E193) — 76 fixed, **14 reopened**, E926 and E927 (new errors from repairs), I380. **16 confirmed-error groups open.** |
...
| `2026-11-14-findings.md` | Round 38: D-252 and D-253 read — **76 of 80 items fixed**; 63 of 64 reopened closures and E926–E933 closed. E386 open; E934 (CPR r.26.9(10)), E935 (sibling errors in other qualifications), I389. **3 confirmed-error groups open.** |
| `2026-11-15-findings.md` | Round 39: D-254 read — I388 applied, siblings left (I390). The repair team's 32 observations worked: 16 confirmed (E936, I391), 16 cleared. **4 confirmed-error groups open.** |
| `2026-11-16-findings.md` | Round 40: D-255 read — **4 of 4 fixed**; E386, E934, E935, I389 closed. Islamiyat Arabic proofread holds on an independent check. **1 confirmed-error group open** (E936). |
...
| `2026-11-24-findings.md` | Round 48: D-262, D-263 and D-264 verified — I400, **E939** and the five I396 deferrals closed; **E944** (6 new errors), I401. **1 confirmed-error group open.** |
| `2026-11-25-findings.md` | Round 49: D-265 verified — **E944** and I401 closed; **E945** (2 errors introduced by the note sweep), I402. **1 confirmed-error group open.** |
| `2026-11-26-findings.md` | Round 50: D-266 verified — **E945** and I402 closed; I403 (session language on 15 hubs), I404 (stale IB coverage count). **0 confirmed-error groups open.** |
...
| | |
|---|---|
| findings recorded | 1,841 |
| confirmed errors open | **1 group** (E946: legal-page short versions not qualified for the regional consent rule) *(reconciliation current through **D-283**; every declared closure D-138 to D-279 read; D-280 to D-283 close no finding. I412 open. **Not a statement that the site is correct.**)* |
| declared closed by decision log D-138–D-283 | 880 |
